...
Begin VB.Form frm_RptSol_06 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_128.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   7740
            Picture         =   "AteCli_frm_128.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   675
            Left            =   7020
            Picture         =   "AteCli_frm_128.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   4
   ...
   End
End
Attribute VB_Name = "frm_RptSol_06"
...
Private Sub fs_Imp_PosPre()
   ...
   If r_int_FlgDat = 1 Then
      crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "COM_SOLHIP_10.RPT"
      crp_Imprim.Action = 1
   Else
