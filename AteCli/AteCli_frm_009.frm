   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_009.frx":0000
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10770
            Picture         =   "AteCli_frm_009.frx":030A
            Style           =   1  'Graphical
            TabIndex        =   103
            ToolTipText     =   "Salir"
            Top             =   8310
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   10050
            Picture         =   "AteCli_frm_009.frx":074C
            Style           =   1  'Graphical
            TabIndex        =   101
         ...
         Begin Threed.SSPanel pnl_Rentis 
            ...
            Begin VB.Label Label16 
               Caption         =   "Tiempo Alquilado (Meses):"
               Height          =   285
               Left            =   60
               TabIndex        =   144
               Top             =   1020
         ...
         Begin Threed.SSPanel pnl_TraDep 
            ...
            Begin VB.CommandButton cmd_ActEco 
               Height          =   675
               Left            =   5100
               Picture         =   "AteCli_frm_009.frx":0A56
               Style           =   1  'Graphical
               TabIndex        =   117
...
Private Sub cmd_Agrega_Click()
   ...
   If txt_RazSoc.Enabled Then
      If Len(Trim(txt_RazSoc.Text)) <> 11 Then
         MsgBox "Debe ingresar la Razón Social.", vbExclamation, modgen_g_con_AteCli
         Call gs_SetFocus(txt_RazSoc)
         Exit Sub
      End If
   
      If Len(Trim(txt_NomCom.Text)) <> 11 Then
         MsgBox "Debe ingresar el Nombre Comercial.", vbExclamation, modgen_g_con_AteCli
   ...
   If l_int_FlgGrb = 1 Then
      ...
      ReDim Preserve modatecli_g_arr_TitActEco(r_int_Indice)
   Else
...
Private Sub cmd_EdiAct_Click()
   ...
   Call gs_BuscarCombo_Item(cmb_ActEco, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_ActEco)
   Call gs_BuscarCombo_Item(cmb_OrdAct, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_OrdAct)
   Call gs_BuscarCombo_Item(cmb_TipDoc, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_TipDoc)
   txt_NumDoc.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_NumDoc
   
   If modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_ActEco <> 21 And modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_ActEco <> 51 Then
      Call fs_BusEmp
   End If
   
   Call gs_BuscarCombo_Item(cmb_CodCiu, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_CodCiu)
   txt_RazSoc.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_RazSoc
   txt_NomCom.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_NomCom
   txt_Sucurs.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_Sucurs
   cmb_GirCom.ListIndex = gf_Busca_Arregl(l_arr_GirCom, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_GiroCd) - 1
   txt_GirCom.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_GiroNm
   Call gs_BuscarCombo_Item(cmb_TipVia, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_TipVia)
   txt_NomVia.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_NomVia
   txt_Numero.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_Numero
   txt_Interi.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_Interi
   Call gs_BuscarCombo_Item(cmb_TipZon, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_TipZon)
   txt_NomZon.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_NomZon
   Call gs_BuscarCombo_Item(cmb_DptDir, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_DptDir)
   Call gs_BuscarCombo_Item(cmb_PrvDir, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_PrvDir)
   Call gs_BuscarCombo_Item(cmb_DstDir, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_DstDir)
   txt_Refere.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_Refere
   txt_Telefo.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_Telefo
   txt_Telef1.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_Telef1
   txt_NumFax.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_NumFax
   
   'Call fs_Activa(True)
   
   Select Case modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_ActEco
      Case 11, 12
         Call fs_Activa_Dep(True)
         
         ipp_Dep_IngNet.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_IngNet
         Call gs_BuscarCombo_Item(cmb_Dep_FreHab, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_FreHab)
         cmb_Dep_NomCar.ListIndex = gf_Busca_Arregl(l_arr_Dep_NomCar, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_CargoC) - 1
         txt_Dep_NomCar.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_CargoN
         txt_Dep_NomAre.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_NomAre
         ipp_Dep_FecIng.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_FecIng
         txt_Dep_Telefo.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_Telefo
         txt_Dep_NumAnx.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_NAnexo
         txt_Dep_Celula.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_Celula
         txt_Dep_DirEle.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_DirEle
         
         If Len(Trim(txt_Dep_DirEle.Text)) = 0 Then
            chk_Dep_DirEle.Enabled = False
         End If
         
         If modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_Autori = 1 Then
            chk_Dep_DirEle.Value = 1
         Else
            chk_Dep_DirEle.Value = 0
         End If
         
         txt_Dep_TlfRhh.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_TlfRhh
         txt_Dep_AnxRhh.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_AnxRhh
         
         If modatecli_g_arr_TitActEco(l_int_OrdAct).ActEco_OrdAct = 9 Then
            ipp_Dep_FecCes.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoDep_FecCes
         End If
         
      Case 21
         Call fs_Activa_Ind(True)
         
         ipp_Ind_IngNet.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_IngNet
         Call gs_BuscarCombo_Item(cmb_Ind_ConLoc, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_ConLoc)
         
         If modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_ConLoc = 1 Then
            Call gs_BuscarCombo_Item(cmb_Ind_TipDoc, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_TipDoc)
            txt_Ind_NumDoc.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_NumDoc
            txt_Ind_RazSoc.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_RazSoc
            txt_Ind_Telef1.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_Telef1
            txt_Ind_Telef2.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoInd_Telef2
         End If
         
      Case 31
         Call fs_Activa_Com(True)
               
         ipp_Com_IngNet.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_IngNet
         ipp_Com_VtaMen.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_VtaMen
         ipp_Com_PorPar.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_PorPar
         ipp_Com_FecIni.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_FecIni
         Call gs_BuscarCombo_Item(cmb_Com_RegTri, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_RegTri)
         Call gs_BuscarCombo_Item(cmb_Com_TipLoc, modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_TipLoc)
         
         If modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_TipLoc = 2 Then
            ipp_Com_AlqMen.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_AlqMen
            txt_Com_NomArr.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_NomArr
            txt_Com_Tl1Arr.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_Tl1Arr
            txt_Com_Tl2Arr.Text = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoCom_Tl2Arr
         End If
         
      Case 41
         Call fs_Activa_Acc(True)
         
         ipp_Acc_IngNet.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoAcc_IngNet
         ipp_Acc_UtiVec.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoAcc_UtiVec
         ipp_Acc_UtiAno.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoAcc_UtiAno
         ipp_Acc_Porcen.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoAcc_Porcen
   
      Case 51
         Call fs_Activa_Ren(True)
         
         ipp_Ren_IngNet.Value = modatecli_g_arr_TitActEco(l_int_OrdAct).ActEcoRen_IngNet
   End Select
   Call gs_SetFocus(cmb_ActEco)
...
Private Sub cmd_Grabar_Click()
   ...
   For r_int_Contad = 1 To UBound(modatecli_g_arr_TitActEco)
      If r_int_Contad = 1 Then
         r_int_Linea1 = modatecli_g_arr_TitActEco(r_int_Contad).ActEco_OrdAct
      End If
      
      If r_int_Contad = 2 Then
         r_int_Linea2 = modatecli_g_arr_TitActEco(r_int_Contad).ActEco_OrdAct
      End If
   
      If r_int_Contad = 3 Then
         r_int_Linea3 = modatecli_g_arr_TitActEco(r_int_Contad).ActEco_OrdAct
      End If
      
      'Obteniendo Actividad Económica Principal - Cliente Titular
      If modatecli_g_arr_TitActEco(r_int_Contad).ActEco_OrdAct = 1 Then
         modatecli_g_int_ActPri_Tit = modatecli_g_arr_TitActEco(r_int_Contad).ActEco_ActEco
      End If
   Next r_int_Contad
...
Private Sub Form_Load()
   ...
   If modatecli_g_int_ActEcoTit = 1 Then
      ...
      cmd_BorAct.Enabled = False
      cmd_EdiAct.Enabled = False
   ElseIf modatecli_g_int_ActEcoTit = 2 Then    'Si ya hay datos ingresados
      For r_int_Contad = 1 To UBound(modatecli_g_arr_TitActEco)
         grd_Listad.Rows = grd_Listad.Rows + 1
         ...
         grd_Listad.Col = 0
         Select Case modatecli_g_arr_TitActEco(r_int_Contad).ActEco_OrdAct
         ...
         grd_Listad.Col = 2
         grd_Listad.Text = modatecli_g_arr_TitActEco(r_int_Contad).ActEco_OrdAct
         
         grd_Listad.Col = 1
         Select Case modatecli_g_arr_TitActEco(r_int_Contad).ActEco_ActEco
...
Private Sub fs_Arreglo_Genera(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_ActEco = cmb_ActEco.ItemData(cmb_ActEco.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_OrdAct = cmb_OrdAct.ItemData(cmb_OrdAct.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_TipDoc = cmb_TipDoc.ItemData(cmb_TipDoc.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NumDoc = txt_NumDoc.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_CodCiu = cmb_CodCiu.ItemData(cmb_CodCiu.ListIndex)
   
   If pnl_FlgEmp.Visible And pnl_FlgEmp.Caption = "NR" And (cmb_ActEco.ItemData(cmb_ActEco.ListIndex) <> 21) Then
      modatecli_g_arr_TitActEco(p_Indice).ActEco_EmpReg = 2
   Else
      modatecli_g_arr_TitActEco(p_Indice).ActEco_EmpReg = 1
   End If
   
   modatecli_g_arr_TitActEco(p_Indice).ActEco_RazSoc = txt_RazSoc.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NomCom = txt_NomCom.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Sucurs = txt_Sucurs.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_GiroCd = l_arr_GirCom(cmb_GirCom.ListIndex + 1).Genera_Codigo
   modatecli_g_arr_TitActEco(p_Indice).ActEco_GiroNm = txt_GirCom.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_TipVia = cmb_TipVia.ItemData(cmb_TipVia.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NomVia = txt_NomVia.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Numero = txt_Numero.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Interi = txt_Interi.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_TipZon = cmb_TipZon.ItemData(cmb_TipZon.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NomZon = txt_NomZon.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_DptDir = cmb_DptDir.ItemData(cmb_DptDir.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_PrvDir = cmb_PrvDir.ItemData(cmb_PrvDir.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_DstDir = cmb_DstDir.ItemData(cmb_DstDir.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Refere = txt_Refere.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Telefo = txt_Telefo.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Telef1 = txt_Telef1.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NumFax = txt_NumFax.Text
End Sub

Private Sub fs_Arreglo_TraDep(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_IngNet = ipp_Dep_IngNet.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_FreHab = cmb_Dep_FreHab.ItemData(cmb_Dep_FreHab.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_CargoC = l_arr_Dep_NomCar(cmb_Dep_NomCar.ListIndex + 1).Genera_Codigo
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_CargoN = txt_Dep_NomCar.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_NomAre = txt_Dep_NomAre.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_FecIng = Format(CDate(ipp_Dep_FecIng.Text), "dd/mm/yyyy")
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_Telefo = txt_Dep_Telefo.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_NAnexo = txt_Dep_NumAnx.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_Celula = txt_Dep_Celula.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_DirEle = txt_Dep_DirEle.Text
   
   If chk_Dep_DirEle.Value = 1 Then
      modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_Autori = 1
   Else
      modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_Autori = 2
   End If
   
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_TlfRhh = txt_Dep_TlfRhh.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_AnxRhh = txt_Dep_AnxRhh.Text
   
   If ipp_Dep_FecCes.Enabled Then
      modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_FecCes = Format(CDate(ipp_Dep_FecCes), "dd/mm/yyyy")
   End If
End Sub

Private Sub fs_Arreglo_TraInd(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_IngNet = ipp_Ind_IngNet.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_ConLoc = cmb_Ind_ConLoc.ItemData(cmb_Ind_ConLoc.ListIndex)
   
   If cmb_Ind_TipDoc.Enabled Then
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_TipDoc = cmb_Ind_TipDoc.ItemData(cmb_Ind_TipDoc.ListIndex)
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_NumDoc = txt_Ind_NumDoc.Text
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_RazSoc = txt_Ind_RazSoc.Text
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_Telef1 = txt_Ind_Telef1.Text
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_Telef2 = txt_Ind_Telef2.Text
   End If
End Sub

Private Sub fs_Arreglo_Comerc(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_IngNet = ipp_Com_IngNet.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_VtaMen = ipp_Com_VtaMen.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_FecIni = Format(CDate(ipp_Com_FecIni.Text), "dd/mm/yyyy")
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_RegTri = cmb_Com_RegTri.ItemData(cmb_Com_RegTri.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_TipLoc = cmb_Com_TipLoc.ItemData(cmb_Com_TipLoc.ListIndex)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_AlqMen = ipp_Com_AlqMen.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_PorPar = ipp_Com_PorPar.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_NomArr = txt_Com_NomArr.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_Tl1Arr = txt_Com_Tl1Arr.Text
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_Tl2Arr = txt_Com_Tl2Arr.Text
End Sub

Private Sub fs_Arreglo_Accion(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_IngNet = ipp_Acc_IngNet.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_UtiVec = ipp_Acc_UtiVec.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_UtiAno = ipp_Acc_UtiAno.Value
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_Porcen = ipp_Acc_Porcen.Value
End Sub

Private Sub fs_Arreglo_Rentis(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoRen_IngNet = ipp_Ren_IngNet.Value
End Sub

Private Sub fs_Limpia_Arreglo(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEco_ActEco = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_OrdAct = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_EmpReg = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_TipDoc = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NumDoc = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_CodCiu = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_RazSoc = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NomCom = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Sucurs = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_GiroCd = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_GiroNm = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_TipVia = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NomVia = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Numero = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Interi = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_TipZon = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NomZon = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_DptDir = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_PrvDir = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_DstDir = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Refere = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Telefo = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_Telef1 = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEco_NumFax = ""
End Sub

Private Sub fs_Limpia_Arreglo_TraDep(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_IngNet = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_FreHab = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_CargoC = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_CargoN = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_NomAre = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_FecIng = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_Telefo = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_NAnexo = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_Celula = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_DirEle = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_Autori = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_TlfRhh = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_AnxRhh = ""
   
   If ipp_Dep_FecCes.Enabled Then
      modatecli_g_arr_TitActEco(p_Indice).ActEcoDep_FecCes = ""
   End If
End Sub

Private Sub fs_Limpia_Arreglo_TraInd(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_IngNet = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_ConLoc = 0
   
   If cmb_Ind_TipDoc.Enabled Then
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_TipDoc = 0
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_NumDoc = ""
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_RazSoc = ""
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_Telef1 = ""
      modatecli_g_arr_TitActEco(p_Indice).ActEcoInd_Telef2 = ""
   End If
End Sub

Private Sub fs_Limpia_Arreglo_Comerc(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_IngNet = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_VtaMen = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_FecIni = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_RegTri = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_PorPar = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_TipLoc = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_AlqMen = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_NomArr = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_Tl1Arr = ""
   modatecli_g_arr_TitActEco(p_Indice).ActEcoCom_Tl2Arr = ""
End Sub

Private Sub fs_Limpia_Arreglo_Accion(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_IngNet = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_UtiVec = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_UtiAno = 0
   modatecli_g_arr_TitActEco(p_Indice).ActEcoAcc_Porcen = 0
End Sub

Private Sub fs_Limpia_Arreglo_Rentis(ByVal p_Indice As Integer)
   modatecli_g_arr_TitActEco(p_Indice).ActEcoRen_IngNet = 0
End Sub

Private Sub fs_BorIte(ByVal p_Item As Integer)
   Dim r_int_Contad     As Integer
   
   If UBound(modatecli_g_arr_TitActEco) = 1 Then
      ReDim modatecli_g_arr_TitActEco(0)
      Exit Sub
   End If
   
   For r_int_Contad = p_Item To UBound(modatecli_g_arr_TitActEco) - 1
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_ActEco = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_ActEco
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_OrdAct = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_OrdAct
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_EmpReg = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_EmpReg
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_TipDoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_TipDoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_NumDoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_NumDoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_CodCiu = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_CodCiu
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_RazSoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_RazSoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_NomCom = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_NomCom
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_Sucurs = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_Sucurs
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_GiroCd = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_GiroCd
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_GiroNm = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_GiroNm
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_TipVia = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_TipVia
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_NomVia = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_NomVia
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_Numero = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_Numero
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_Interi = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_Interi
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_TipZon = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_TipZon
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_NomZon = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_NomZon
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_DptDir = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_DptDir
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_PrvDir = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_PrvDir
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_DstDir = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_DstDir
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_Refere = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_Refere
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_Telefo = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_Telefo
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_Telef1 = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_Telef1
      modatecli_g_arr_TitActEco(r_int_Contad).ActEco_NumFax = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEco_NumFax
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_IngNet = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_IngNet
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_FreHab = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_FreHab
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_CargoC = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_CargoC
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_CargoN = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_CargoN
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_NomAre = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_NomAre
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_FecIng = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_FecIng
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_Telefo = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_Telefo
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_NAnexo = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_NAnexo
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_Celula = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_Celula
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_TlfRhh = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_TlfRhh
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_AnxRhh = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_AnxRhh
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_DirEle = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_DirEle
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_Autori = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_Autori
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoDep_FecCes = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoDep_FecCes
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoInd_IngNet = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoInd_IngNet
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoInd_ConLoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoInd_ConLoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoInd_TipDoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoInd_TipDoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoInd_NumDoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoInd_NumDoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoInd_RazSoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoInd_RazSoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoInd_Telef1 = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoInd_Telef1
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoInd_Telef2 = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoInd_Telef2
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_IngNet = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_IngNet
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_VtaMen = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_VtaMen
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_PorPar = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_PorPar
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_FecIni = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_FecIni
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_RegTri = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_RegTri
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_TipLoc = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_TipLoc
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_AlqMen = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_AlqMen
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_NomArr = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_NomArr
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_Tl1Arr = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_Tl1Arr
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoCom_Tl2Arr = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoCom_Tl2Arr
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoAcc_IngNet = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoAcc_IngNet
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoAcc_UtiVec = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoAcc_UtiVec
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoAcc_UtiAno = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoAcc_UtiAno
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoAcc_Porcen = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoAcc_Porcen
      modatecli_g_arr_TitActEco(r_int_Contad).ActEcoRen_IngNet = modatecli_g_arr_TitActEco(r_int_Contad + 1).ActEcoRen_IngNet
   Next r_int_Contad
   
   ReDim Preserve modatecli_g_arr_TitActEco(UBound(modatecli_g_arr_TitActEco) - 1)
End Sub
