   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel11 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   12000
            Picture         =   "AteCli_frm_045.frx":0004
            Style           =   1  'Graphical
            TabIndex        =   9
         ...
         Begin VB.CommandButton cmd_RecDoc 
            Height          =   675
            Left            =   11310
            Picture         =   "AteCli_frm_045.frx":0446
            Style           =   1  'Graphical
            TabIndex        =   8
            ToolTipText     =   "Tarjetas de Crédito, Deudas y Gastos"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   1085
            _StockProps     =   15
            Caption         =   "Recepción de Documentos Legales"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_045.frx":0888
            Top             =   60
            Width           =   480
         End
      End
...
Private Sub cmd_RecDoc_Click()
   ...
   If ff_Grabar() Then
      ...
      modgen_g_str_Mail_Asunto = "RECEPCION DE DOCUMENTOS PARA EVALUACION LEGAL (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub fs_Carga_Docume()
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "SELECT * FROM CRE_PARMOD WHERE "
   g_str_Parame = g_str_Parame & "PARMOD_CODPRD = '" & moddat_g_str_CodPrd & "' AND "
   g_str_Parame = g_str_Parame & "PARMOD_CODMOD = '" & moddat_g_str_CodMod & "' AND "
   g_str_Parame = g_str_Parame & "PARMOD_CODGRP = '007' AND "
   g_str_Parame = g_str_Parame & "PARMOD_CODITE <> '000' AND "
   g_str_Parame = g_str_Parame & "PARMOD_SITUAC = 1 "
   g_str_Parame = g_str_Parame & "ORDER BY PARMOD_CODITE ASC "

   If Not gf_EjecutaSQL(g_str_Parame, g_rst_Genera, 3) Then
       Exit Sub
   End If
   
   If g_rst_Genera.EOF And g_rst_Genera.EOF Then
     g_rst_Genera.Close
     Set g_rst_Genera = Nothing
     
     MsgBox "No se han encontrado Lista de Documentos Legales.", vbExclamation, modgen_g_con_PltPar
     Exit Sub
   End If
   ...
   Do While Not g_rst_Genera.EOF
      ...
      grd_Listad.Col = 0
      grd_Listad.Text = g_rst_Genera!PARMOD_DESCRI
      
      grd_Listad.Col = 1
      grd_Listad.Text = ""
      
      grd_Listad.Col = 2
      grd_Listad.Text = Right(g_rst_Genera!PARMOD_CODITE, 3)
...
Private Function ff_Grabar() As Integer
   ...
   If Not moddat_gf_Inserta_SegDet(moddat_g_str_NumSol, modatecli_g_con_EvaLeg, 23, 0, txt_Observ.Text, 0, 0) Then
      Exit Function
   End If
   ...
   For r_int_Contad = 0 To grd_Listad.Rows - 1
      ...
      If r_str_FlgDoc = "X" Then
         'If Not moddat_gf_Inserta_SolDoc(moddat_g_str_NumSol, 4, grd_Listad.Text, Format(CDate(moddat_g_str_FecSis), "yyyymmdd")) Then
            Exit Function
         'End If
      End If
   Next r_int_Contad
