...
Begin VB.Form frm_ConSol_52 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "AteCli_frm_152.frx":000C
            ...
            TabPicture(1)   =   "AteCli_frm_152.frx":0028
            ...
            TabPicture(2)   =   "AteCli_frm_152.frx":0044
            ...
            TabPicture(3)   =   "AteCli_frm_152.frx":0060
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(6)   =   "AteCli_frm_152.frx":0138
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_152.frx":0158
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_152.frx":0462
            Style           =   1  'Graphical
            TabIndex        =   67
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "AteCli_frm_152.frx":08A4
            Style           =   1  'Graphical
            TabIndex        =   58
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_ConSol_52"
...
Private Sub cmd_Imprim_Click()
   ...
   crp_Imprim.DataFiles(1) = UCase(moddat_g_str_EntDat) & ".TRA_EVACRE"
   crp_Imprim.DataFiles(2) = UCase(moddat_g_str_EntDat) & ".CLI_DATGEN"
   crp_Imprim.DataFiles(3) = UCase(moddat_g_str_EntDat) & ".TRA_SEGUIM"
   crp_Imprim.DataFiles(4) = UCase(moddat_g_str_EntDat) & ".CRE_SUBPRD"
   crp_Imprim.DataFiles(5) = UCase(moddat_g_str_EntDat) & ".CRE_PRODUC"
...
Private Sub fs_DatCre()
   ...
   l_int_CodIns = g_rst_Princi!SOLMAE_CODINS
...
Private Sub fs_Buscar_EvaCre()
   ...
   If g_rst_Princi!EVACRE_MTOPRE_CAL > 0 Then
      ...
      If moddat_g_int_TipMon <> 1 Then
         ...
         grd_LisEva.CellFontName = "Lucida Console"
         grd_LisEva.CellFontSize = 8
         grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_TIPCAM, 14, 4)
      End If
   ...
   grd_LisEva.Col = 0
   grd_LisEva.CellForeColor = modgen_g_con_ColRoj
   grd_LisEva.Text = "Cuota Mensual Máxima"
   ...
   grd_LisEva.Col = 0
   grd_LisEva.CellForeColor = modgen_g_con_ColRoj
   grd_LisEva.Text = "Cuota Mensual Máxima M. Prest."
   ...
   If moddat_g_int_TipMon <> 1 Then
      ...
      grd_LisEva.CellFontSize = 8
      grd_LisEva.CellForeColor = modgen_g_con_ColRoj
      grd_LisEva.Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_TCAING, 14, 4)
   End If
