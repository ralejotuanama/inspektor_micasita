...
Begin VB.Form frm_SegSol_54 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "AteCli_frm_153.frx":000C
            ...
            TabPicture(2)   =   "AteCli_frm_153.frx":0044
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(6)   =   "AteCli_frm_153.frx":011C
            Tab(6).ControlEnabled=   0   'False
            Tab(6).Control(0)=   "grd_Listad(6)"
            Tab(6).ControlCount=   1
            TabCaption(7)   =   "Ev. Crediticia"
            TabPicture(7)   =   "AteCli_frm_153.frx":0138
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_153.frx":0158
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_DatInm 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_153.frx":0462
            Style           =   1  'Graphical
            TabIndex        =   57
         ...
         Begin VB.CommandButton cmd_Aprueb 
            Height          =   585
            Left            =   1230
            Picture         =   "AteCli_frm_153.frx":0D2C
            Style           =   1  'Graphical
            TabIndex        =   56
         ...
         Begin VB.CommandButton cmd_Rechaz 
            Height          =   585
            Left            =   1830
            Picture         =   "AteCli_frm_153.frx":1036
            Style           =   1  'Graphical
            TabIndex        =   55
         ...
         Begin VB.CommandButton cmd_CalCuo 
            Height          =   585
            Left            =   630
            Picture         =   "AteCli_frm_153.frx":1478
            Style           =   1  'Graphical
            TabIndex        =   54
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "AteCli_frm_153.frx":178A
            Style           =   1  'Graphical
            TabIndex        =   53
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_SegSol_54"
...
Private Sub cmd_Aprueb_Click()
   ...
   If CDbl(pnl_CuoFin_Sol.Caption) > l_dbl_CuoApr Then
      If (moddat_g_str_CodPrd = "002") Or (moddat_g_str_CodPrd = "004" And (l_int_TipEva = 3 Or l_int_TipEva = 4)) Or _
         (moddat_g_str_CodPrd = "007" And (l_int_TipEva = 3 Or l_int_TipEva = 4)) Then
         
         If modgen_g_int_TipUsu = 20200 Or modgen_g_int_TipUsu = 20220 Or modgen_g_int_TipUsu = 1000 Then
            If MsgBox("La cuota obtenida es mayor a la cuota aprobada. ¿Desea aprobar la operación?", vbQuestion + vbDefaultButton2 + vbYesNo, modgen_g_str_NomPlt) <> vbYes Then
               Exit Sub
            End If
   ...
   modgen_g_str_Mail_Asunto = moddat_gf_Consulta_ParDes("002", "31") & " - APROBACION " & "(" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub cmd_CalCuo_Click()
   ...
   Select Case moddat_g_str_CodPrd
      ...
      Case "006"
         pnl_CuoFin_Sol.Caption = "619.04 "
         pnl_CuoFin_MPr.Caption = "619.04 "
...
Private Sub cmd_Rechaz_Click()
   ...
   If moddat_g_int_MotRec > 0 Then
      ...
      modgen_g_str_Mail_Asunto = moddat_gf_Consulta_ParDes("002", "31") & " - RECHAZO " & "(" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub fs_Limpia()
   ...
   lbl_TipMon(0).Caption = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon))
   lbl_TipMon(1).Caption = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon))
   lbl_TipMon(2).Caption = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon))
   lbl_TipMon(3).Caption = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon))
End Sub
...
Private Sub fs_RegExc()
   ...
   If Not moddat_gf_Inserta_SegExc(moddat_g_str_NumSol, 31, r_int_NumExc, "CUOTA MAYOR A LA APROBADA POR DIFERENCIA DE TIPO DE CAMBIO.", r_int_NivAut) Then
      Exit Sub
   End If
End Sub
