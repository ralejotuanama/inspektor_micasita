   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   979
            _StockProps     =   15
            Caption         =   "Reporte de Solicitudes en Pólizas y Mivivienda-Cofide"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   8.25
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_535.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "AteCli_frm_535.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   1
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_535.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   0
            ToolTipText     =   "Imprimir Reporte"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   4770
            Picture         =   "AteCli_frm_535.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   2
...
Private Sub cmd_Imprim_Click()
   ...
   g_str_Parame = g_str_Parame & "SOLTRA_NOMRPT = 'ATE_RPTSOL_25.RPT' AND "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         r_dbl_IngIns = ff_IngIns(g_rst_Princi!SOLMAE_NUMERO, 61)
         
         r_str_SitTas = ff_SitIns(g_rst_Princi!SOLMAE_NUMERO, 61)
         r_str_SitSeg = ff_SitIns(g_rst_Princi!SOLMAE_NUMERO, 62)
         ...
         g_str_Parame = g_str_Parame & "'" & "ATE_RPTSOL_25.RPT" & "', "
   ...
   crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "ATE_RPTSOL_25.RPT"
   
   crp_Imprim.SelectionFormula = "{RPT_SOLTRA.SOLTRA_NOMRPT} = 'ATE_RPTSOL_25.RPT' AND "
...
Private Sub fs_GenExc()
   ...
   With r_obj_Excel.ActiveSheet
      ...
      .Cells(1, 8) = "SITUACION POLIZAS"
      .Cells(1, 9) = "SITUACION MVI-COF"
