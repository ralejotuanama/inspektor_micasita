...
Begin VB.Form frm_RptSol_20 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_510.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   660
            Picture         =   "AteCli_frm_510.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   60
            Picture         =   "AteCli_frm_510.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   4
            ToolTipText     =   "Imprimir Reporte"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   4740
            Picture         =   "AteCli_frm_510.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frm_RptSol_20"
...
Private Sub cmd_Imprim_Click()
   ...
   If chk_Produc.Value = 0 Then
      crp_Imprim.SelectionFormula = crp_Imprim.SelectionFormula & "{CRE_SOLMAE.SOLMAE_CODPRD} = '" & l_arr_Produc(cmb_TipPro.ListIndex + 1).Genera_Codigo & "' AND "
   End If
...
Private Sub fs_GenExc()
   ...
   With r_obj_Excel.ActiveSheet
      ...
      .Columns("V").ColumnWidth = 17
      .Columns("W").ColumnWidth = 60
      .Columns("X").ColumnWidth = 17
   ...
   Do While Not g_rst_Princi.EOF
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 11) = gf_Formato_NumOpe(Trim(g_rst_Princi!HIPMAE_NUMOPE))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 12) = CStr(g_rst_Princi!SOLMAE_TASINT) + "%"
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 13) = g_rst_Princi!HIPMAE_PLAANO
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 14) = g_rst_Princi!HIPMAE_PERGRA
            
      If g_rst_Princi!SOLMAE_TIPMON = 1 Then
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 15) = "NUEVOS SOLES"
      Else
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 15) = "DOLARES AMERICANOS"
      End If
      
      If g_rst_Princi!SOLMAE_TIPMON = 1 Then
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 16) = Format(g_rst_Princi!SOLMAE_COMVTA_SOL, "###,###,##0.00")
      Else
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 19) = Format(fs_Buscar_ValorAseg(Trim(g_rst_Princi!SOLMAE_NUMERO)), "###,###,##0.00")
...
Private Sub fs_GenExc_Nueva()
   ...
   g_str_Parame = g_str_Parame & " WHERE A.SOLMAE_SITUAC = 2 "
   ...
   If chk_Produc.Value = 0 Then
      g_str_Parame = g_str_Parame & "   AND A.SOLMAE_CODPRD = '" & l_arr_Produc(cmb_TipPro.ListIndex + 1).Genera_Codigo & "' "
   End If
   'Restricción por Tipo de Usuario
   If modgen_g_int_TipUsu = 20121 Then
