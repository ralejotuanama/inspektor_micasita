...
Begin VB.Form frm_SegSol_09 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "AteCli_frm_117.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   16
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   1085
            _StockProps     =   15
            Caption         =   "Seguimiento de Solicitud - Verificación Crediticia"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_117.frx":044E
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel11 
         ...
         Begin VB.CommandButton cmd_GraObs 
            Height          =   675
            Left            =   10140
            Picture         =   "AteCli_frm_117.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_CanObs 
            Height          =   675
            Left            =   10830
            Picture         =   "AteCli_frm_117.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   42
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   675
            Left            =   9450
            Picture         =   "AteCli_frm_117.frx":0EA4
            Style           =   1  'Graphical
            TabIndex        =   41
   ...
   End
End
Attribute VB_Name = "frm_SegSol_09"
...
Private Sub cmd_GraObs_Click()
   ...
   If Not moddat_gf_Modifica_SegDet_Observ(moddat_g_str_NumSol, 71, 21, CStr(CInt(r_str_NumObs)), txt_Descar.Text, 2) Then
      Exit Sub
   End If
   
   'Actualizando en Instancia
   If Not moddat_gf_Modifica_Seguim(moddat_g_str_NumSol, 71, 0, 9, 2) Then
      Exit Sub
   End If
   ...
   modgen_g_str_Mail_Asunto = "DESCARGO DE OBSERVACION EN VERIFICACION CREDITICIA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
...
Private Sub fs_Buscar_Seguim()
   ...
   g_str_Parame = g_str_Parame & "SEGUIM_CODINS = 71"
...
Private Sub fs_Buscar_LisOcu()
   ...
   g_str_Parame = g_str_Parame & "SEGDET_CODINS = 71 "
...
Private Sub fs_Envia_CorEle(ByVal p_Asunto As String, ByVal p_Mensaje As String)
   ...
   r_str_Cadena = moddat_gf_UsuObs(moddat_g_str_NumSol, 71)
   ReDim Preserve moddat_g_arr_Genera(UBound(moddat_g_arr_Genera) + 1)
...
Private Sub fs_Buscar_DatEva()
   ...
   grd_LisEva.Col = 0
   grd_LisEva.Text = "Total Ingreso Líquido"
   
   grd_LisEva.Col = 1
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!VERCRE_INGDP1 + g_rst_Princi!VERCRE_INGDP2 + g_rst_Princi!VERCRE_INGDP3 + g_rst_Princi!VERCRE_INGDP4, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!VERCRE_CUOSOL, 12, 2)
   ...
   grd_LisEva.CellFontName = "Lucida Console"
   grd_LisEva.CellFontSize = 8
   grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!VERCRE_CUOMPR, 12, 2)
   ...
   If moddat_g_int_TipMon <> 1 Then
      ...
      grd_LisEva.CellFontName = "Lucida Console"
      grd_LisEva.CellFontSize = 8
      grd_LisEva.Text = gf_FormatoNumero(g_rst_Princi!VERCRE_TIPCAM, 12, 4)
   End If
