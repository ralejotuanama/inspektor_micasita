...
Begin VB.Form frm_ConSol_57 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_162.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "AteCli_frm_162.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   6
            ToolTipText     =   "Salir"
            Top             =   30
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "AteCli_frm_162.frx":07AC
            Tab(0).ControlEnabled=   -1  'True
            ...
            TabPicture(1)   =   "AteCli_frm_162.frx":07C8
            Tab(1).ControlEnabled=   0   'False
            ...
            TabPicture(2)   =   "AteCli_frm_162.frx":07E4
            Tab(2).ControlEnabled=   0   'False
            ...
            TabPicture(3)   =   "AteCli_frm_162.frx":0800
   ...
   End
End
Attribute VB_Name = "frm_ConSol_57"
...
Private Sub fs_Buscar_DatEva()
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      If g_rst_Princi!EVALEG_FECCVT > 0 Then
         ...
         grd_LisEva(0).Col = 0
         grd_LisEva(0).Text = "Fecha Firma Contrato Compra Venta"
         
         grd_LisEva(0).Col = 1
         grd_LisEva(0).Text = gf_FormatoFecha(CStr(g_rst_Princi!EVALEG_FECCVT))
         ...
         If g_rst_Princi!EVALEG_TCACVT > 0 Then
            ...
            grd_LisEva(0).Row = grd_LisEva(0).Rows - 1
            grd_LisEva(0).Col = 0
            grd_LisEva(0).Text = "Tipo de Cambio aplicado"
            
            grd_LisEva(0).Col = 1
            grd_LisEva(0).Text = Format(g_rst_Princi!EVALEG_TCACVT, "###,##0.0000")
         End If
      End If
      ...
      If g_rst_Princi!EVALEG_FIRCON > 0 Then
         ...
         grd_LisEva(0).Col = 1
         grd_LisEva(0).CellFontName = "Lucida Console"
         grd_LisEva(0).CellFontSize = 8
         grd_LisEva(0).Text = moddat_gf_Consulta_ParDes("229", g_rst_Princi!EVALEG_MONHIP) & " " & gf_FormatoNumero(g_rst_Princi!EVALEG_MTOHIP, 12, 2)
      End If
      
      If grd_LisEva(0).Rows > 0 Then
