...
Begin VB.Form frm_ActCon_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab tab_Consul 
            ...
            TabPicture(0)   =   "AteCli_frm_528.frx":000C
            ...
            TabPicture(1)   =   "AteCli_frm_528.frx":0028
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "pnl_Prd_PorMto"
            Tab(1).Control(1)=   "pnl_Prd_PorCan"
            Tab(1).Control(2)=   "SSPanel29"
            Tab(1).Control(3)=   "SSPanel28"
            Tab(1).Control(4)=   "SSPanel27"
            Tab(1).Control(5)=   "SSPanel26"
            Tab(1).Control(6)=   "SSPanel25"
            Tab(1).Control(7)=   "SSPanel24"
            Tab(1).Control(8)=   "grd_Prd_Listad"
            Tab(1).Control(9)=   "SSPanel23"
            Tab(1).Control(10)=   "SSPanel22"
            Tab(1).Control(11)=   "SSPanel21"
            Tab(1).Control(12)=   "SSPanel20"
            Tab(1).Control(13)=   "pnl_Prd_Cantid"
            Tab(1).Control(14)=   "pnl_Prd_MtoSol"
            Tab(1).Control(15)=   "pnl_Prd_MtoDol"
            Tab(1).Control(16)=   "pnl_Prd_MtoTot"
            Tab(1).ControlCount=   17
            TabCaption(2)   =   "Modalidad"
            TabPicture(2)   =   "AteCli_frm_528.frx":0044
            Tab(2).ControlEnabled=   0   'False
            Tab(2).Control(0)=   "pnl_Mod_PorMto"
            Tab(2).Control(1)=   "pnl_Mod_PorCan"
            Tab(2).Control(2)=   "SSPanel40"
            Tab(2).Control(3)=   "SSPanel39"
            Tab(2).Control(4)=   "SSPanel38"
            Tab(2).Control(5)=   "SSPanel37"
            Tab(2).Control(6)=   "SSPanel36"
            Tab(2).Control(7)=   "SSPanel35"
            Tab(2).Control(8)=   "grd_Mod_Listad"
            Tab(2).Control(9)=   "SSPanel34"
            Tab(2).Control(10)=   "SSPanel33"
            Tab(2).Control(11)=   "SSPanel31"
            Tab(2).Control(12)=   "SSPanel30"
            Tab(2).Control(13)=   "pnl_Mod_Cantid"
            Tab(2).Control(14)=   "pnl_Mod_MtoSol"
            Tab(2).Control(15)=   "pnl_Mod_MtoDol"
            Tab(2).Control(16)=   "pnl_Mod_MtoTot"
            Tab(2).ControlCount=   17
            TabCaption(3)   =   "Tipo de Evaluación"
            TabPicture(3)   =   "AteCli_frm_528.frx":0060
            Tab(3).ControlEnabled=   0   'False
            Tab(3).Control(0)=   "pnl_Eva_PorMto"
            Tab(3).Control(1)=   "pnl_Eva_PorCan"
            Tab(3).Control(2)=   "SSPanel68"
            Tab(3).Control(3)=   "SSPanel67"
            Tab(3).Control(4)=   "SSPanel66"
            Tab(3).Control(5)=   "SSPanel65"
            Tab(3).Control(6)=   "SSPanel64"
            Tab(3).Control(7)=   "SSPanel63"
            Tab(3).Control(8)=   "grd_Eva_Listad"
            Tab(3).Control(9)=   "SSPanel54"
            Tab(3).Control(10)=   "SSPanel43"
            Tab(3).Control(11)=   "SSPanel32"
            Tab(3).Control(12)=   "SSPanel19"
            Tab(3).Control(13)=   "pnl_Eva_Cantid"
            Tab(3).Control(14)=   "pnl_Eva_MtoSol"
            Tab(3).Control(15)=   "pnl_Eva_MtoDol"
            Tab(3).Control(16)=   "pnl_Eva_MtoTot"
            Tab(3).ControlCount=   17
            TabCaption(4)   =   "Proyecto Inmobiliario Vinculado"
            TabPicture(4)   =   "AteCli_frm_528.frx":007C
            Tab(4).ControlEnabled=   0   'False
            Tab(4).Control(0)=   "pnl_Vin_PorMto"
            Tab(4).Control(1)=   "pnl_Vin_PorCan"
            Tab(4).Control(2)=   "SSPanel51"
            Tab(4).Control(3)=   "SSPanel50"
            Tab(4).Control(4)=   "SSPanel49"
            Tab(4).Control(5)=   "SSPanel48"
            Tab(4).Control(6)=   "SSPanel47"
            Tab(4).Control(7)=   "SSPanel46"
            Tab(4).Control(8)=   "grd_Vin_Listad"
            Tab(4).Control(9)=   "SSPanel45"
            Tab(4).Control(10)=   "SSPanel44"
            Tab(4).Control(11)=   "SSPanel42"
            Tab(4).Control(12)=   "SSPanel41"
            Tab(4).Control(13)=   "pnl_Vin_Cantid"
            Tab(4).Control(14)=   "pnl_Vin_MtoSol"
            Tab(4).Control(15)=   "pnl_Vin_MtoDol"
            Tab(4).Control(16)=   "pnl_Vin_MtoTot"
            Tab(4).ControlCount=   17
            TabCaption(5)   =   "Proyecto Inmobiliario No Vinculado"
            TabPicture(5)   =   "AteCli_frm_528.frx":0098
            Tab(5).ControlEnabled=   0   'False
            Tab(5).Control(0)=   "pnl_NVi_PorMto"
            Tab(5).Control(1)=   "pnl_NVi_PorCan"
            Tab(5).Control(2)=   "SSPanel62"
            Tab(5).Control(3)=   "SSPanel61"
            Tab(5).Control(4)=   "SSPanel60"
            Tab(5).Control(5)=   "SSPanel59"
            Tab(5).Control(6)=   "SSPanel58"
            Tab(5).Control(7)=   "SSPanel57"
            Tab(5).Control(8)=   "grd_NVi_Listad"
            Tab(5).Control(9)=   "SSPanel56"
            Tab(5).Control(10)=   "SSPanel55"
            Tab(5).Control(11)=   "SSPanel53"
            Tab(5).Control(12)=   "pnl_NVi_Cantid"
            Tab(5).Control(13)=   "pnl_NVi_MtoSol"
            Tab(5).Control(14)=   "pnl_NVi_MtoDol"
            Tab(5).Control(15)=   "pnl_NVi_MtoTot"
            Tab(5).Control(16)=   "SSPanel52"
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   11430
            Picture         =   "AteCli_frm_528.frx":00B4
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_528.frx":04F6
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   630
            Picture         =   "AteCli_frm_528.frx":0800
            Style           =   1  'Graphical
            TabIndex        =   3
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   1230
            Picture         =   "AteCli_frm_528.frx":0B0A
            Style           =   1  'Graphical
            TabIndex        =   4
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_528.frx":0E14
            Top             =   60
            Width           =   480
         End
      End
   End
End
Attribute VB_Name = "frm_ActCon_01"
...
Private Sub cmd_Buscar_Click()
   ...
   moddat_g_str_CodGrp = l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo
   moddat_g_str_DesGrp = cmb_ConHip.Text
   ...
   Call fs_Buscar_Eva(l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo)
...
Private Sub cmd_ExpExc_Click()
   ...
   With r_obj_Excel.ActiveSheet
      .Cells(1, 1) = "CONSEJERO HIPOTECARIO"
      
      Select Case tab_Consul.Tab
         Case 0:  .Cells(1, 2) = "INSTANCIA"
         Case 1:  .Cells(1, 2) = "PRODUCTO"
         Case 2:  .Cells(1, 2) = "MODALIDAD"
         Case 3:  .Cells(1, 2) = "TIPO DE EVALUACION"
         Case 4:  .Cells(1, 2) = "PROYECTO VINCULADO"
         Case 5:  .Cells(1, 2) = "PROYECTO NO VINCULADO"
         Case 6:  .Cells(1, 2) = "INSTANCIA"
      End Select
      
      .Cells(1, 3) = "TIPO DE CAMBIO"
      .Cells(1, 4) = "NRO. SOLICITUDES"
      .Cells(1, 5) = "MONTO EN S/."
      .Cells(1, 6) = "MONTO EN US$"
      .Cells(1, 7) = "MONTO TOTAL"
      .Cells(1, 8) = "% NRO. SOLICITUDES"
      .Cells(1, 9) = "% MONTO PRESTAMO"
   ...
   Select Case tab_Consul.Tab
      Case 0
         ...
         For r_int_Contad = 0 To grd_Ins_Listad.Rows - 1
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 1) = moddat_g_str_DesGrp
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 3) = Format(ipp_TipCam.Value, "###,###0.00")
            
            grd_Ins_Listad.Col = 0
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 2) = grd_Ins_Listad.Text
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 9) = grd_Ins_Listad.Text
         Next r_int_Contad
      ...
      Case 1
         ...
         For r_int_Contad = 0 To grd_Prd_Listad.Rows - 1
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 2) = grd_Prd_Listad.Text
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 9) = grd_Prd_Listad.Text
         Next r_int_Contad
      ...
      Case 2
         ...
         For r_int_Contad = 0 To grd_Mod_Listad.Rows - 1
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 2) = grd_Mod_Listad.Text
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 9) = grd_Mod_Listad.Text
         Next r_int_Contad
      ...
      Case 3
         ...
         For r_int_Contad = 0 To grd_Eva_Listad.Rows - 1
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 2) = grd_Eva_Listad.Text
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 9) = grd_Eva_Listad.Text
         Next r_int_Contad
      ...
      Case 4
         ...
         For r_int_Contad = 0 To grd_Vin_Listad.Rows - 1
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 2) = grd_Vin_Listad.Text
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 9) = grd_Vin_Listad.Text
         Next r_int_Contad
      ...
      Case 5
         ...
         For r_int_Contad = 0 To grd_NVi_Listad.Rows - 1
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 2) = grd_NVi_Listad.Text
            ...
            r_obj_Excel.ActiveSheet.Cells(r_int_Contad + 2, 9) = grd_NVi_Listad.Text
         Next r_int_Contad
...
Private Sub fs_Buscar_Eva(ByVal p_ConHip As String)
   Dim r_int_CanSol     As Integer
   Dim r_int_CanDol     As Integer
   Dim r_dbl_TotSol     As Double
   Dim r_dbl_TotDol     As Double
