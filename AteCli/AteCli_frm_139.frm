   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_SegSol 
            Height          =   675
            Left            =   16200
            Picture         =   "AteCli_frm_139.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   2
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   675
            Left            =   14100
            Picture         =   "AteCli_frm_139.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   7
         ...
         Begin VB.CommandButton cmd_BusCli 
            Height          =   675
            Left            =   14790
            Picture         =   "AteCli_frm_139.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   675
            Left            =   15480
            Picture         =   "AteCli_frm_139.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   16170
            Picture         =   "AteCli_frm_139.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   4
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   873
            _StockProps     =   15
            Caption         =   "Seguimiento de Solicitudes Rechazadas de Crédito Hipotecario"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_139.frx":1076
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel pnl_SolEva 
         ...
         Begin Threed.SSPanel pnl_Tit_NomCli 
            ...
            Outline         =   -1  'True
         End
         Begin Threed.SSPanel pnl_Tit_FecRec 
            Height          =   285
            Left            =   9990
            TabIndex        =   22
            Top             =   60
         ...
         Begin Threed.SSPanel pnl_Tit_ConHip 
            ...
            Outline         =   -1  'True
         End
         Begin Threed.SSPanel pnl_Tit_MotRec 
            Height          =   285
            Left            =   13020
            TabIndex        =   25
            Top             =   60
...
Private Sub fs_Inicia()
   ...
   grd_Listad.ColWidth(2) = 1385
   grd_Listad.ColWidth(3) = 3635
   grd_Listad.ColWidth(4) = 1175
   grd_Listad.ColWidth(5) = 1850
   grd_Listad.ColWidth(6) = 3470
...
Private Sub fs_Buscar()
   g_str_Parame = "SELECT * FROM CRE_SOLMAE A WHERE "
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 8
      grd_Listad.Text = CStr(g_rst_Princi!SOLMAE_FECREC)
...
Private Sub pnl_Tit_FecRec_Click()
   If Len(Trim(pnl_Tit_FecRec.Tag)) = 0 Or pnl_Tit_FecRec.Tag = "D" Then
      pnl_Tit_FecRec.Tag = "A"
      Call gs_SorteaGrid(grd_Listad, 8, "N")
   Else
      pnl_Tit_FecRec.Tag = "D"
      Call gs_SorteaGrid(grd_Listad, 8, "N-")
   End If
End Sub

Private Sub pnl_Tit_MotRec_Click()
   If Len(Trim(pnl_Tit_MotRec.Tag)) = 0 Or pnl_Tit_MotRec.Tag = "D" Then
      pnl_Tit_MotRec.Tag = "A"
      Call gs_SorteaGrid(grd_Listad, 6, "C")
   Else
      pnl_Tit_MotRec.Tag = "D"
      Call gs_SorteaGrid(grd_Listad, 6, "C-")
   End If
End Sub
