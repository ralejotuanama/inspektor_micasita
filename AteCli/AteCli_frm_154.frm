...
Begin VB.Form frm_ConSol_53 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "AteCli_frm_154.frx":000C
            ...
            TabPicture(1)   =   "AteCli_frm_154.frx":0028
            ...
            TabPicture(2)   =   "AteCli_frm_154.frx":0044
            ...
            TabPicture(3)   =   "AteCli_frm_154.frx":0060
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin TabDlg.SSTab SSTab1 
            ...
            TabPicture(0)   =   "AteCli_frm_154.frx":0090
            Tab(0).ControlEnabled=   -1  'True
            Tab(0).Control(0)=   "grd_Listad(0)"
            Tab(0).Control(0).Enabled=   0   'False
            Tab(0).ControlCount=   1
            TabCaption(1)   =   "Datos Cónyuge"
            TabPicture(1)   =   "AteCli_frm_154.frx":00AC
            Tab(1).ControlEnabled=   0   'False
            Tab(1).Control(0)=   "grd_Listad(1)"
            Tab(1).ControlCount=   1
            TabCaption(2)   =   "Datos Patrimonio"
            TabPicture(2)   =   "AteCli_frm_154.frx":00C8
            Tab(2).ControlEnabled=   0   'False
            Tab(2).Control(0)=   "grd_Listad(4)"
            Tab(2).ControlCount=   1
            TabCaption(3)   =   "Refer. Person."
            TabPicture(3)   =   "AteCli_frm_154.frx":00E4
            Tab(3).ControlEnabled=   0   'False
            Tab(3).Control(0)=   "grd_Listad(3)"
            Tab(3).ControlCount=   1
            TabCaption(4)   =   "Datos Inmueb."
            TabPicture(4)   =   "AteCli_frm_154.frx":0100
            Tab(4).ControlEnabled=   0   'False
            Tab(4).Control(0)=   "grd_Listad(2)"
            Tab(4).ControlCount=   1
            TabCaption(5)   =   "Datos Crédito"
            TabPicture(5)   =   "AteCli_frm_154.frx":011C
            Tab(5).ControlEnabled=   0   'False
            Tab(5).Control(0)=   "txt_ObsSol"
            Tab(5).Control(1)=   "grd_Listad(5)"
            Tab(5).Control(2)=   "Label5"
            Tab(5).ControlCount=   3
            TabCaption(6)   =   "Docum. Recib."
            TabPicture(6)   =   "AteCli_frm_154.frx":0138
            Tab(6).ControlEnabled=   0   'False
            Tab(6).Control(0)=   "grd_Listad(6)"
            Tab(6).ControlCount=   1
            TabCaption(7)   =   "Ev. Crediticia"
            TabPicture(7)   =   "AteCli_frm_154.frx":0154
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_154.frx":0174
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "AteCli_frm_154.frx":047E
            Style           =   1  'Graphical
            TabIndex        =   64
            ToolTipText     =   "Salir"
            Top             =   30
   ...
   End
End
Attribute VB_Name = "frm_ConSol_53"
...
Private Sub fs_Buscar_EvaCre()
   ...
   If g_rst_Princi!EVACRE_MTOPRE_CAL > 0 Then
      grd_Listad(7).Rows = grd_Listad(7).Rows + 1
      grd_Listad(7).Row = grd_Listad(7).Rows - 1
      grd_Listad(7).Col = 0
      grd_Listad(7).Text = "Monto Préstamo Aprobado"
      
      grd_Listad(7).Col = 1
      grd_Listad(7).CellFontName = "Lucida Console"
      grd_Listad(7).CellFontSize = 8
      grd_Listad(7).Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(g_rst_Princi!EVACRE_MTOPRE_CAL, 12, 2)
      
      grd_Listad(7).Rows = grd_Listad(7).Rows + 1
      grd_Listad(7).Row = grd_Listad(7).Rows - 1
      grd_Listad(7).Col = 0
      grd_Listad(7).Text = "Plazo Aprobado"
      
      grd_Listad(7).Col = 1
      grd_Listad(7).CellFontName = "Lucida Console"
      grd_Listad(7).CellFontSize = 8
      grd_Listad(7).Text = CStr(g_rst_Princi!EVACRE_PLAANO_CAL) & " Años "
      
      grd_Listad(7).Rows = grd_Listad(7).Rows + 1
      grd_Listad(7).Row = grd_Listad(7).Rows - 1
      grd_Listad(7).Col = 0
      grd_Listad(7).Text = "Período de Gracia Aprobado"
      
      grd_Listad(7).Col = 1
      grd_Listad(7).CellFontName = "Lucida Console"
      grd_Listad(7).CellFontSize = 8
      grd_Listad(7).Text = CStr(g_rst_Princi!EVACRE_PERGRA_CAL) & IIf(g_rst_Princi!EVACRE_PERGRA_CAL = 1, " Mes", " Meses")
      
      If moddat_g_int_TipMon <> 1 Then
         grd_Listad(7).Rows = grd_Listad(7).Rows + 1
         grd_Listad(7).Row = grd_Listad(7).Rows - 1
         grd_Listad(7).Col = 0
         grd_Listad(7).Text = "Tipo de Cambio de Aprobación"
         
         grd_Listad(7).Col = 1
         grd_Listad(7).CellFontName = "Lucida Console"
         grd_Listad(7).CellFontSize = 8
         grd_Listad(7).Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_TIPCAM, 14, 4)
      End If
      
      grd_Listad(7).Rows = grd_Listad(7).Rows + 1
      grd_Listad(7).Row = grd_Listad(7).Rows - 1
      grd_Listad(7).Col = 0
      grd_Listad(7).Text = "Tipo de Seguro Aprobado"
      
      grd_Listad(7).Col = 1
      grd_Listad(7).Text = moddat_gf_Consulta_TipSeg(l_str_EmpSeg, g_rst_Princi!EVACRE_TIPSEG_CAL)
   ...
   grd_Listad(7).Row = grd_Listad(7).Rows - 1
   grd_Listad(7).Col = 0
   grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
   grd_Listad(7).Text = "Total Ingreso Líquido Neto S/."
   
   grd_Listad(7).Col = 1
   grd_Listad(7).CellFontName = "Lucida Console"
   grd_Listad(7).CellFontSize = 8
   grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
   grd_Listad(7).Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_INGNET, 12, 2)
   
   grd_Listad(7).Rows = grd_Listad(7).Rows + 1
   grd_Listad(7).Row = grd_Listad(7).Rows - 1
   grd_Listad(7).Col = 0
   grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
   grd_Listad(7).Text = "Cuota Mensual Máxima"
   
   grd_Listad(7).Col = 1
   grd_Listad(7).CellFontName = "Lucida Console"
   grd_Listad(7).CellFontSize = 8
   grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
   grd_Listad(7).Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_CUOSOL, 12, 2)
   
   grd_Listad(7).Rows = grd_Listad(7).Rows + 1
   grd_Listad(7).Row = grd_Listad(7).Rows - 1
   grd_Listad(7).Col = 0
   grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
   grd_Listad(7).Text = "Cuota Mensual Máxima M. Prest."
   
   grd_Listad(7).Col = 1
   grd_Listad(7).CellFontName = "Lucida Console"
   grd_Listad(7).CellFontSize = 8
   grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
   grd_Listad(7).Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(g_rst_Princi!EVACRE_CUOMPR, 12, 2)
   ...
   If moddat_g_int_TipMon <> 1 Then
      ...
      grd_Listad(7).Col = 0
      grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
      grd_Listad(7).Text = "Tipo de Cambio (Cálculo Ingresos)"
      
      grd_Listad(7).Col = 1
      grd_Listad(7).CellFontName = "Lucida Console"
      grd_Listad(7).CellFontSize = 8
      grd_Listad(7).CellForeColor = modgen_g_con_ColRoj
      grd_Listad(7).Text = "S/. " & gf_FormatoNumero(g_rst_Princi!EVACRE_TCAING, 14, 4)
   End If
