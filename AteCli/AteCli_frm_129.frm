   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10830
            Picture         =   "AteCli_frm_129.frx":0010
            Style           =   1  'Graphical
            TabIndex        =   17
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   1085
            _StockProps     =   15
            Caption         =   "Seguimiento de Solicitud - Trámites Mivivienda"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_129.frx":0452
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel11 
         ...
         Begin VB.CommandButton cmd_GraObs 
            Height          =   675
            Left            =   10140
            Picture         =   "AteCli_frm_129.frx":075C
            Style           =   1  'Graphical
            TabIndex        =   44
         ...
         Begin VB.CommandButton cmd_CanObs 
            Height          =   675
            Left            =   10830
            Picture         =   "AteCli_frm_129.frx":0B9E
            Style           =   1  'Graphical
            TabIndex        =   43
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   675
            Left            =   9450
            Picture         =   "AteCli_frm_129.frx":0EA8
            Style           =   1  'Graphical
            TabIndex        =   42
...
Private Sub cmd_GraObs_Click()
   ...
   If Not moddat_gf_Modifica_SegDet_Observ(moddat_g_str_NumSol, 62, 21, CStr(CInt(r_str_NumObs)), txt_Descar.Text, 2) Then
      Exit Sub
   End If
   
   'Actualizando en Instancia
   If Not moddat_gf_Modifica_Seguim(moddat_g_str_NumSol, 62, 0, 9, 2) Then
      Exit Sub
   End If
   ...
   modgen_g_str_Mail_Asunto = "DESCARGO DE OBSERVACION EN TRAMITES MIVIVIENDA (" & Format(CDate(moddat_g_str_FecSis), "dd/mm/yyyy") & " - " & Format(Time, "hh:mm:ss") & ")"
