...
Begin VB.Form frm_CamCon_11 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_LimOpe 
            Height          =   585
            Left            =   7410
            Picture         =   "AteCli_frm_181.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   7
         ...
         Begin VB.CommandButton cmd_BusOpe 
            Height          =   585
            Left            =   6810
            Picture         =   "AteCli_frm_181.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   6
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         EndProperty
         BevelOuter      =   1
         Begin Threed.SSPanel pnl_TituloVentana 
            Height          =   495
            Left            =   630
            TabIndex        =   26
            Top             =   60
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_181.frx":0620
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_BusCli 
            Height          =   585
            Left            =   6810
            Picture         =   "AteCli_frm_181.frx":092A
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmd_LimBus 
            Height          =   585
            Left            =   7410
            Picture         =   "AteCli_frm_181.frx":0C34
            Style           =   1  'Graphical
            TabIndex        =   13
      ...
      Begin Threed.SSPanel SSPanel5 
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   6210
            Picture         =   "AteCli_frm_181.frx":0F3E
            Style           =   1  'Graphical
            TabIndex        =   1
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   6810
            Picture         =   "AteCli_frm_181.frx":1248
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7410
            Picture         =   "AteCli_frm_181.frx":1552
            Style           =   1  'Graphical
            TabIndex        =   3
            ToolTipText     =   "Salir"
            Top             =   390
   ...
   End
End
Attribute VB_Name = "frm_CamCon_11"
...
Dim r_int_Moneda     As Integer
   ...
   g_str_Parame = g_str_Parame & "SOLMAE_NUMERO = '" & msk_NumOpe.Text & "' AND "
...
Private Sub Form_Load()
   ...
   Select Case moddat_g_int_FlgPre
      Case 5: Me.pnl_TituloVentana.Caption = "Cambio de Consejero Hipotecario"
      Case 6: Me.pnl_TituloVentana.Caption = "Actualización de Tasa de solicitud de Crédito"
      Case Else: Me.pnl_TituloVentana.Caption = ""
   End Select
