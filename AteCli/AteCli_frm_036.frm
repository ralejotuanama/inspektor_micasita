   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin Threed.SSPanel SSPanel7 
            ...
            _ExtentY        =   1085
            _StockProps     =   15
            Caption         =   "Seguimiento de Evaluación de Certificados de No-Propiedad"
            ForeColor       =   32768
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "MS Sans Serif"
               Size            =   12
...
Private Sub Form_Load()
   ...
   'Habilitando Botón de Recepción de Documentos
...
Private Sub fs_Valida_RecDoc()
   ...
   'Si se encuentra en Instancia de Tasación
   If moddat_g_int_InsAct = modatecli_g_con_CerNPr Then
      'Verificar que ya no se haya efectuado Recepción de Documentos
