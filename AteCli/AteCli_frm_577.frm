...
Begin VB.Form frm_RptSol_51 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_577.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   4740
            Picture         =   "AteCli_frm_577.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_577.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   5
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "AteCli_frm_577.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_ExpDet 
            Height          =   585
            Left            =   1230
            Picture         =   "AteCli_frm_577.frx":0EA4
            Style           =   1  'Graphical
            TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "frm_RptSol_51"
...
Private Sub fs_Activa(ByVal p_Habilita As Integer)
   Chk_IncDup.Enabled = Not p_Habilita
   Chk_IncNue.Enabled = Not p_Habilita
   cmd_ExpDet.Enabled = Not p_Habilita
End Sub
...
Private Function ff_Produc(ByVal p_Produc As String) As String
   g_str_Parame = "SELECT SOLMAE_CODPRD FROM CRE_SOLMAE WHERE "
...
Private Function ff_ConHip(ByVal p_ConHip As String) As String
   g_str_Parame = "SELECT SOLMAE_CONHIP FROM CRE_SOLMAE WHERE "
...
Private Function ff_TotIng_Mes_TipPro(ByVal p_Produc As String) As Integer
   ff_TotIng_Mes_TipPro = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      g_rst_Listas.MoveFirst
      ff_TotIng_Mes_TipPro = g_rst_Listas!TOTING
   End If
...
Private Function ff_Pendie_Mes_TipPro(ByVal p_Produc As String) As Integer
   ff_Pendie_Mes_TipPro = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      g_rst_Listas.MoveFirst
      Do While Not g_rst_Listas.EOF
         ff_Pendie_Mes_TipPro = ff_Pendie_Mes_TipPro + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
Private Function ff_AprCre_Mes_TipPro(ByVal p_Produc As String) As Integer
   ff_AprCre_Mes_TipPro = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      g_rst_Listas.MoveFirst
      Do While Not g_rst_Listas.EOF
         ff_AprCre_Mes_TipPro = ff_AprCre_Mes_TipPro + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
Private Function ff_AprGas_Mes_TipPro(ByVal p_Produc As String) As Integer
   ff_AprGas_Mes_TipPro = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      g_rst_Listas.MoveFirst
      Do While Not g_rst_Listas.EOF
         ff_AprGas_Mes_TipPro = ff_AprGas_Mes_TipPro + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
Private Function ff_TotDes_Mes_TipPro(ByVal p_Produc As String) As Integer
   ff_TotDes_Mes_TipPro = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_TotDes_Mes_TipPro = ff_TotDes_Mes_TipPro + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
Private Function ff_Pendie_Tot_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoPen_Sol As Double, Optional ByRef ff_MtoPen_Dol As Double) As Integer
   ff_Pendie_Tot_TipPro = 0
   ff_MtoPen_Sol = 0
   ff_MtoPen_Dol = 0
        
   g_str_Parame = "SELECT SOLMAE_TIPMON, SOLMAE_MTOPRE_MPR FROM CRE_SOLMAE, RPT_SOLTRA WHERE "
   g_str_Parame = g_str_Parame & "SOLMAE_NUMERO = SOLTRA_NUMSOL AND "
   g_str_Parame = g_str_Parame & "SOLMAE_CODPRD = '" & Trim(p_Produc) & "' AND "
   g_str_Parame = g_str_Parame & "SOLMAE_CODINS < 31 AND "
   g_str_Parame = g_str_Parame & "SOLTRA_PAGFEC = 0 AND "
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_Pendie_Tot_TipPro = ff_Pendie_Tot_TipPro + 1
...
Private Function ff_AprCre_Tot_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoPre_Sol As Double, Optional ByRef ff_MtoPre_Dol As Double) As Integer
   ff_AprCre_Tot_TipPro = 0
   ff_MtoPre_Sol = 0
   ff_MtoPre_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_AprCre_Tot_TipPro = ff_AprCre_Tot_TipPro + 1
...
Private Function ff_AprGas_Tot_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoGas_Sol As Double, Optional ByRef ff_MtoGas_Dol As Double) As Integer
   ff_AprGas_Tot_TipPro = 0
   ff_MtoGas_Sol = 0
   ff_MtoGas_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_AprGas_Tot_TipPro = ff_AprGas_Tot_TipPro + 1
...
'TRAMITE DE TASACION
Private Function ff_TraTas_Tot_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoTas_Sol As Double, Optional ByRef ff_MtoTas_Dol As Double) As Integer
   ff_TraTas_Tot_TipPro = 0
   ff_MtoTas_Sol = 0
   ff_MtoTas_Dol = 0
        
   g_str_Parame = "SELECT SOLMAE_TIPMON, SOLMAE_MTOPRE_MPR FROM CRE_SOLMAE WHERE "
   g_str_Parame = g_str_Parame & "SOLMAE_CODPRD = '" & Trim(p_Produc) & "' AND "
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_TraTas_Tot_TipPro = ff_TraTas_Tot_TipPro + 1
...
'TRAMITE LEGAL
Private Function ff_TraLeg_Tot_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoLeg_Sol As Double, Optional ByRef ff_MtoLeg_Dol As Double) As Integer
   ff_TraLeg_Tot_TipPro = 0
   ff_MtoLeg_Sol = 0
   ff_MtoLeg_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_TraLeg_Tot_TipPro = ff_TraLeg_Tot_TipPro + 1
...
Private Function ff_Otros_Tot_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoOtr_Sol As Double, Optional ByRef ff_MtoOtr_Dol As Double) As Integer
   ff_Otros_Tot_TipPro = 0
   ff_MtoOtr_Sol = 0
   ff_MtoOtr_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_Otros_Tot_TipPro = ff_Otros_Tot_TipPro + 1
...
'STOCK APROBADOS
Private Function ff_Stock_Tot_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoSto_Sol As Double, Optional ByRef ff_MtoSto_Dol As Double) As Integer
   ff_Stock_Tot_TipPro = 0
   ff_MtoSto_Sol = 0
   ff_MtoSto_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_Stock_Tot_TipPro = ff_Stock_Tot_TipPro + 1
...
Private Function ff_CanDes_Mes_TipPro(ByVal p_Produc As String, Optional ByRef ff_MtoDes_Sol As Double, Optional ByRef ff_MtoDes_Dol As Double) As Integer
   ff_CanDes_Mes_TipPro = 0
   ff_MtoDes_Sol = 0
   ff_MtoDes_Dol = 0
   
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "SELECT SOLMAE_TIPMON, SOLMAE_MTOPRE_MPR  "
   g_str_Parame = g_str_Parame & "  FROM CRE_SOLMAE INNER JOIN CRE_HIPMAE ON SOLMAE_NUMERO = HIPMAE_NUMSOL "
   g_str_Parame = g_str_Parame & " WHERE SOLMAE_CODPRD = '" & Trim(p_Produc) & "' AND "
   g_str_Parame = g_str_Parame & "       SOLMAE_SITUAC = 2 AND "
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_CanDes_Mes_TipPro = ff_CanDes_Mes_TipPro + 1
...
Private Function ff_CanRec_Mes_TipPro(ByVal p_Produc As String) As Integer
   ff_CanRec_Mes_TipPro = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_CanRec_Mes_TipPro = ff_CanRec_Mes_TipPro + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
Private Sub Rpt_SolTra()
   ...
   g_str_Parame = "SELECT SOLMAE_NUMERO FROM CRE_SOLMAE WHERE "
   g_str_Parame = g_str_Parame & "SOLMAE_SITUAC = 1 "
...
'   g_str_Parame = g_str_Parame & "SOLMAE_SITUAC = 1 "
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & " SELECT DISTINCT A.SOLMAE_CONHIP, NVL(TOTING,0) AS TOTING, NVL(PEND_ATECOM_EVACRED,0) AS PENDIENTES, NVL(RECHAZADAS,0) AS RECHAZADAS,"
   g_str_Parame = g_str_Parame & "        NVL(DESEMBOLSADOS,0) AS DESEMBOLSADOS, NVL(APROB_EV_CRED,0) AS APROB_EV_CRED, NVL(APROB_G_C,0) AS APROB_G_C,"
   g_str_Parame = g_str_Parame & "        NVL(CANDES,0) AS CANDES, NVL(MTODES_SOL,0) AS MTODES_SOL, NVL(MTODES_DOL,0) AS MTODES_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANPEN,0) AS CANPEN, NVL(MTOPEN_SOL,0) AS MTOPEN_SOL, NVL(MTOPEN_DOL,0) AS MTOPEN_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANCRE,0) AS CANCRE, NVL(MTOCRE_SOL,0) AS MTOCRE_SOL, NVL(MTOCRE_DOL,0) AS MTOCRE_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANGAS,0) AS CANGAS, NVL(MTOGAS_SOL,0) AS MTOGAS_SOL, NVL(MTOGAS_DOL,0) AS MTOGAS_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANTAS,0) AS CANTAS, NVL(MTOTAS_SOL,0) AS MTOTAS_SOL, NVL(MTOTAS_DOL,0) AS MTOTAS_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANLEG,0) AS CANLEG, NVL(MTOLEG_SOL,0) AS MTOLEG_SOL, NVL(MTOLEG_DOL,0) AS MTOLEG_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANOTR,0) AS CANOTR, NVL(MTOOTR_SOL,0) AS MTOOTR_SOL, NVL(MTOOTR_DOL,0) AS MTOOTR_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANSTO,0) AS CANSTO, NVL(MTOSTO_SOL,0) AS MTOSTO_SOL, NVL(MTOSTO_DOL,0) AS MTOSTO_DOL"
   g_str_Parame = g_str_Parame & "   FROM CRE_SOLMAE A"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT SOLMAE_CONHIP, COUNT(*) AS TOTING"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP) B ON B.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT SOLMAE_CONHIP, COUNT(*) AS PEND_ATECOM_EVACRED"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_CODINS < 31 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP) C ON  C.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT SOLMAE_CONHIP, COUNT(*) AS RECHAZADAS"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE (SOLMAE_SITUAC = 3 Or SOLMAE_SITUAC = 9)"
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP) D ON D.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT SOLMAE_CONHIP, COUNT(*) AS DESEMBOLSADOS"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_SITUAC = 2"
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP) E ON E.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT SOLMAE_CONHIP, COUNT(*) AS APROB_EV_CRED"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_CODINS > 21"
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP) F ON F.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT SOLMAE_CONHIP, COUNT(*) AS APROB_G_C"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC <> 0"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP) G ON G.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANDES, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTODES_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTODES_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE INNER JOIN CRE_HIPMAE ON SOLMAE_NUMERO = HIPMAE_NUMSOL"
   ...
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_SITUAC = 2"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) H ON H.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANPEN, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOPEN_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOPEN_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC = 0"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_CODINS < 31"
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) I ON I.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANCRE, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOCRE_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOCRE_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC = 0"
   g_str_Parame = g_str_Parame & "                WHERE (SOLMAE_CODINS = 31 Or SOLMAE_CODINS = 32) And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) J ON J.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANGAS, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOGAS_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOGAS_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC > 0"
   g_str_Parame = g_str_Parame & "                WHERE (SOLMAE_CODINS = 31 Or SOLMAE_CODINS = 32) And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) K ON K.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANTAS, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOTAS_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOTAS_DOL"
   g_str_Parame = g_str_Parame & "                 From CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE (SOLMAE_CODINS = 41 Or SOLMAE_CODINS = 42) And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) L ON L.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANLEG, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOLEG_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOLEG_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_CODINS = 51 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) M ON M.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANOTR, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOOTR_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOOTR_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_CODINS > 51 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) N ON N.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANSTO, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOSTO_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOSTO_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                WHERE SOLMAE_CODINS > 21 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) O ON O.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & " WHERE SOLMAE_SITUAC = 1"
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         ...
         r_str_ConHip = Trim(g_rst_Princi!SOLMAE_CONHIP) 'Trim(ff_ConHip(g_rst_Princi!SOLMAE_CONHIP))
         
         'Para obtener el Total Ingreso Mensual
         r_int_TotIng_Mes = g_rst_Princi!TOTING 'ff_TotIng_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
         
         'Para obtener la Cantidad de solicitudes q se encuentran en evaluacion crediticia y atencion comercial
         r_int_Pendie_Mes = g_rst_Princi!PENDIENTES 'ff_Pendie_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
         
         'Para obtener la Aprobacion Crediticia Mensual
         r_int_AprCre_Mes = g_rst_Princi!APROB_EV_CRED 'ff_AprCre_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
         
         'Para Obtener la cantidad de Aprobacion Con Gastos de Cierre Mensual
         r_int_AprGas_Mes = g_rst_Princi!APROB_G_C 'ff_AprGas_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
         
         'Para Obtener la cantidad de Desembolsos en el Mes
         r_int_TotDes_Mes = g_rst_Princi!DESEMBOLSADOS 'ff_TotDes_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
                  
         'Para la Obtencion de las solicitudes Que se encuentran en Atencion Comercial y Evaluación Crediticia
         r_int_Pendie_Tot = g_rst_Princi!CANPEN 'ff_Pendie_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoPen_Sol, r_dbl_MtoPen_Dol)
         r_dbl_MtoPen_Sol = g_rst_Princi!MTOPEN_SOL
         r_dbl_MtoPen_Dol = g_rst_Princi!MTOPEN_DOL
         
         'Para la Obtencion de las solicitudes Aprobadas en Tramite
         r_int_AprCre_Tot = g_rst_Princi!CANCRE 'ff_AprCre_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoCre_Sol, r_dbl_MtoCre_Dol)
         r_dbl_MtoCre_Sol = g_rst_Princi!MTOCRE_SOL
         r_dbl_MtoCre_Dol = g_rst_Princi!MTOCRE_DOL
         
         'Para Obtener la Aprobacion de Gastos de Cierre en Tramite
         r_int_AprGas_Tot = g_rst_Princi!CANGAS 'ff_AprGas_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoGas_Sol, r_dbl_MtoGas_Dol)
         r_dbl_MtoGas_Sol = g_rst_Princi!MTOGAS_SOL
         r_dbl_MtoGas_Dol = g_rst_Princi!MTOGAS_DOL
         
         'Para Obtener la cantidad de solicitudes en Tasacion en Tramite
         r_int_TraTas_Tot = g_rst_Princi!CANTAS 'ff_TraTas_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoTas_Sol, r_dbl_MtoTas_Dol)
         r_dbl_MtoTas_Sol = g_rst_Princi!MTOTAS_SOL
         r_dbl_MtoTas_Dol = g_rst_Princi!MTOTAS_DOL
         
         'Para Obtener las solicitudes que se encuentran en Legal en Tramite
         r_int_TraLeg_Tot = g_rst_Princi!CANLEG 'ff_TraLeg_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoLeg_Sol, r_dbl_MtoLeg_Dol)
         r_dbl_MtoLeg_Sol = g_rst_Princi!MTOLEG_SOL
         r_dbl_MtoLeg_Dol = g_rst_Princi!MTOLEG_DOL
         
         'Para Otener el numero de solicitudes que se encuentran en instancias mayores a legal y en tramite
         r_int_Otros_Tot = g_rst_Princi!CANOTR 'ff_Otros_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoOtr_Sol, r_dbl_MtoOtr_Dol)
         r_dbl_MtoOtr_Sol = g_rst_Princi!MTOOTR_SOL
         r_dbl_MtoOtr_Dol = g_rst_Princi!MTOOTR_DOL
         
         'Para Obtener el numero de solicitudes en stock en tramite
         r_int_Stock_Tot = g_rst_Princi!CANSTO 'ff_Stock_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoSto_Sol, r_dbl_MtoSto_Dol)
         r_dbl_MtoSto_Sol = g_rst_Princi!MTOSTO_SOL
         r_dbl_MtoSto_Dol = g_rst_Princi!MTOSTO_DOL
         
         'Para Obtener el numero de desembolso del mes seleccionado
         r_int_CanDes_Mes = g_rst_Princi!CANDES 'ff_CanDes_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoDes_Sol, r_dbl_MtoDes_Dol)
         r_dbl_MtoDes_Sol = g_rst_Princi!MTODES_SOL
         r_dbl_MtoDes_Dol = g_rst_Princi!MTODES_DOL
         
         'Para Obtener el numero de Rechazos del mes seleccionado
         r_int_CanRec_Mes = g_rst_Princi!RECHAZADAS 'ff_CanRec_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
   ...
   crp_Imprim.DataFiles(0) = "RPT_SEGSOL"
...
'   g_str_Parame = g_str_Parame & "SOLMAE_SITUAC = 1 "
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "  SELECT DISTINCT A.SOLMAE_CODPRD, PRODUC_DESCRI, NVL(B.TOTING,0) AS TOTING, NVL(C.PEND_ATECOM_EVACRED,0) AS PEND_ATECOM_EVACRED, NVL(D.RECHAZADAS,0) AS RECHAZADAS,"
   g_str_Parame = g_str_Parame & "             NVL(E.DESEMBOLSADOS,0) AS DESEMBOLSADOS, NVL(F.APROB_EV_CRED,0) AS APROB_EV_CRED, NVL(APROB_G_C,0) AS APROB_G_C,"
   g_str_Parame = g_str_Parame & "             NVL(CANDES,0) AS CANDES, NVL(MTODES_SOL,0) AS MTODES_SOL, NVL(MTODES_DOL,0) AS MTODES_DOL,"
   g_str_Parame = g_str_Parame & "             NVL(CANPEN,0) AS CANPEN, NVL(MTOPEN_SOL,0) AS MTOPEN_SOL, NVL(MTOPEN_DOL,0) AS MTOPEN_DOL,"
   g_str_Parame = g_str_Parame & "             NVL(CANCRE,0) AS CANCRE, NVL(MTOCRE_SOL,0) AS MTOCRE_SOL, NVL(MTOCRE_DOL,0) AS MTOCRE_DOL,"
   g_str_Parame = g_str_Parame & "             NVL(CANGAS,0) AS CANGAS, NVL(MTOGAS_SOL,0) AS MTOGAS_SOL, NVL(MTOGAS_DOL,0) AS MTOGAS_DOL,"
   ...
   g_str_Parame = g_str_Parame & "             NVL(CANSTO,0) AS CANSTO, NVL(MTOSTO_SOL,0) AS MTOSTO_SOL, NVL(MTOSTO_DOL,0) AS MTOSTO_DOL"
   g_str_Parame = g_str_Parame & "    FROM CRE_SOLMAE A"
   g_str_Parame = g_str_Parame & "     INNER JOIN CRE_PRODUC ON PRODUC_CODIGO = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT SOLMAE_CODPRD, COUNT(*) AS TOTING"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD) B ON B.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT SOLMAE_CODPRD, COUNT(*) AS PEND_ATECOM_EVACRED"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_CODINS < 31 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD) C ON  C.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT SOLMAE_CODPRD, COUNT(*) AS RECHAZADAS"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE (SOLMAE_SITUAC = 3 Or SOLMAE_SITUAC = 9)"
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD) D ON D.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT SOLMAE_CODPRD, COUNT(*) AS DESEMBOLSADOS"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_SITUAC = 2"
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD) E ON E.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT SOLMAE_CODPRD, COUNT(*) AS APROB_EV_CRED"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_CODINS > 21"
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD) F ON F.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT SOLMAE_CODPRD, COUNT(*) AS APROB_G_C"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC <> 0"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_FECSOL <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD) G ON G.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANDES, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTODES_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTODES_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE INNER JOIN CRE_HIPMAE ON SOLMAE_NUMERO = HIPMAE_NUMSOL"
   g_str_Parame = g_str_Parame & "                   AND HIPMAE_FECDES >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                   AND HIPMAE_FECDES <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & " "
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_SITUAC = 2"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) H ON H.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANPEN, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOPEN_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOPEN_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC = 0"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_CODINS < 31"
   g_str_Parame = g_str_Parame & "                   AND SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) I ON I.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANCRE, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOCRE_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOCRE_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC = 0"
   g_str_Parame = g_str_Parame & "                 WHERE (SOLMAE_CODINS = 31 Or SOLMAE_CODINS = 32) And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) J ON J.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANGAS, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOGAS_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOGAS_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC > 0"
   g_str_Parame = g_str_Parame & "                 WHERE (SOLMAE_CODINS = 31 Or SOLMAE_CODINS = 32) And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) K ON K.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANTAS, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOTAS_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOTAS_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE (SOLMAE_CODINS = 41 Or SOLMAE_CODINS = 42) And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) L ON L.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANLEG, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOLEG_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOLEG_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_CODINS = 51 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) M ON M.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANOTR, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOOTR_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOOTR_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_CODINS > 51 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) N ON N.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & "     LEFT JOIN (SELECT COUNT(*) AS CANSTO, SOLMAE_CODPRD, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOSTO_SOL,"
   g_str_Parame = g_str_Parame & "                       CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOSTO_DOL"
   g_str_Parame = g_str_Parame & "                  FROM CRE_SOLMAE"
   g_str_Parame = g_str_Parame & "                 WHERE SOLMAE_CODINS > 21 And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                 GROUP BY SOLMAE_CODPRD, SOLMAE_TIPMON) O ON O.SOLMAE_CODPRD = A.SOLMAE_CODPRD"
   g_str_Parame = g_str_Parame & " WHERE SOLMAE_SITUAC = 1 ORDER BY SOLMAE_CODPRD ASC "
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      Do While Not g_rst_Princi.EOF
         'Para obtener el Consejero Hipotecario
         r_str_Produc = Trim(g_rst_Princi!SOLMAE_CODPRD) 'Trim(ff_Produc(g_rst_Princi!SOLMAE_CODPRD))
         
         'Para obtener el Total Ingreso Mensual
         r_int_TotIng_Mes = g_rst_Princi!TOTING 'ff_TotIng_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD)
         
         'Para obtener la Cantidad de solicitudes q se encuentran en evaluacion crediticia y atencion comercial
         r_int_Pendie_Mes = g_rst_Princi!PEND_ATECOM_EVACRED 'ff_Pendie_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD)
         
         'Para obtener la Aprobacion Crediticia Mensual
         r_int_AprCre_Mes = g_rst_Princi!APROB_EV_CRED 'ff_AprCre_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD)
         
         'Para Obtener la cantidad de Aprobacion Con Gastos de Cierre Mensual
         r_int_AprGas_Mes = g_rst_Princi!APROB_G_C 'ff_AprGas_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD)
         
         'Para Obtener la cantidad de Desembolsos en el Mes
         r_int_TotDes_Mes = g_rst_Princi!DESEMBOLSADOS 'ff_TotDes_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD)
                  
         'Para la Obtencion de las solicitudes Que se encuentran en Atencion Comercial y Evaluación Crediticia
         r_int_Pendie_Tot = g_rst_Princi!CANPEN 'ff_Pendie_Tot_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoPen_Sol, r_dbl_MtoPen_Dol)
         r_dbl_MtoPen_Sol = g_rst_Princi!MTOPEN_SOL
         r_dbl_MtoPen_Dol = g_rst_Princi!MTOPEN_DOL
         
         'Para la Obtencion de las solicitudes Aprobadas en Tramite
         r_int_AprCre_Tot = g_rst_Princi!CANCRE 'ff_AprCre_Tot_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoCre_Sol, r_dbl_MtoCre_Dol)
         r_dbl_MtoCre_Sol = g_rst_Princi!MTOCRE_SOL
         r_dbl_MtoCre_Dol = g_rst_Princi!MTOCRE_DOL
         
         'Para Obtener la Aprobacion de Gastos de Cierre en Tramite
         r_int_AprGas_Tot = g_rst_Princi!CANGAS 'ff_AprGas_Tot_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoGas_Sol, r_dbl_MtoGas_Dol)
         r_dbl_MtoGas_Sol = g_rst_Princi!MTOGAS_SOL
         r_dbl_MtoGas_Dol = g_rst_Princi!MTOGAS_DOL
         
         'Para Obtener la cantidad de solicitudes en Tasacion en Tramite
         r_int_TraTas_Tot = g_rst_Princi!CANTAS  'ff_TraTas_Tot_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoTas_Sol, r_dbl_MtoTas_Dol)
         r_dbl_MtoTas_Sol = g_rst_Princi!MTOTAS_SOL
         r_dbl_MtoTas_Dol = g_rst_Princi!MTOTAS_DOL
         
         'Para Obtener las solicitudes que se encuentran en Legal en Tramite
         r_int_TraLeg_Tot = g_rst_Princi!CANLEG  'ff_TraLeg_Tot_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoLeg_Sol, r_dbl_MtoLeg_Dol)
         r_dbl_MtoLeg_Sol = g_rst_Princi!MTOLEG_SOL
         r_dbl_MtoLeg_Dol = g_rst_Princi!MTOLEG_DOL
         
         'Para Otener el numero de solicitudes que se encuentran en instancias mayores a legal y en tramite
         r_int_Otros_Tot = g_rst_Princi!CANOTR  'ff_Otros_Tot_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoOtr_Sol, r_dbl_MtoOtr_Dol)
         r_dbl_MtoOtr_Sol = g_rst_Princi!MTOOTR_SOL
         r_dbl_MtoOtr_Dol = g_rst_Princi!MTOOTR_DOL
         
         'Para Obtener el numero de solicitudes en stock en tramite
         r_int_Stock_Tot = g_rst_Princi!CANSTO  'ff_Stock_Tot_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoSto_Sol, r_dbl_MtoSto_Dol)
         r_dbl_MtoSto_Sol = g_rst_Princi!MTOSTO_SOL
         r_dbl_MtoSto_Dol = g_rst_Princi!MTOSTO_DOL
         
         'Para Obtener el numero de desembolso del mes seleccionado
         r_int_CanDes_Mes = g_rst_Princi!CANDES  'ff_CanDes_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD, r_dbl_MtoDes_Sol, r_dbl_MtoDes_Dol)
         r_dbl_MtoDes_Sol = g_rst_Princi!MTODES_SOL
         r_dbl_MtoDes_Dol = g_rst_Princi!MTODES_DOL
         
         'Para Obtener el numero de Rechazos del mes seleccionado
         r_int_CanRec_Mes = g_rst_Princi!RECHAZADAS  'ff_CanRec_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD)
   ...
   'Se envia las tablas correspondientes en el orden que fueron utilizadas
   crp_Imprim.DataFiles(0) = "RPT_SEGPRO"
...
'   g_str_Parame = g_str_Parame & "ORDER BY SOLMAE_CONHIP ASC "
   ...
   g_str_Parame = g_str_Parame & "        NVL(CANDES,0) AS CANDES, NVL(MTODES_SOL,0) AS MTODES_SOL, NVL(MTODES_DOL,0) AS MTODES_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANPEN,0) AS CANPEN, NVL(MTOPEN_SOL,0) AS MTOPEN_SOL, NVL(MTOPEN_DOL,0) AS MTOPEN_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANPRE,0) AS CANPRE, NVL(MTOPRE_SOL,0) AS MTOPRE_SOL, NVL(MTOPRE_DOL,0) AS MTOPRE_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANGAS,0) AS CANGAS, NVL(MTOGAS_SOL,0) AS MTOGAS_SOL, NVL(MTOGAS_DOL,0) AS MTOGAS_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANTAS,0) AS CANTAS, NVL(MTOTAS_SOL,0) AS MTOTAS_SOL, NVL(MTOTAS_DOL,0) AS MTOTAS_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANLEG,0) AS CANLEG, NVL(MTOLEG_SOL,0) AS MTOLEG_SOL, NVL(MTOLEG_DOL,0) AS MTOLEG_DOL,"
   g_str_Parame = g_str_Parame & "        NVL(CANOTR,0) AS CANOTR, NVL(MTOOTR_SOL,0) AS MTOOTR_SOL, NVL(MTOOTR_DOL,0) AS MTOOTR_DOL,"
   ...
   g_str_Parame = g_str_Parame & "                  AND SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) I ON I.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANPRE, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOPRE_SOL,"
   g_str_Parame = g_str_Parame & "                      CASE WHEN SOLMAE_TIPMON = 2 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOPRE_DOL"
   g_str_Parame = g_str_Parame & "                 FROM CRE_SOLMAE INNER JOIN RPT_SOLTRA ON SOLMAE_NUMERO = SOLTRA_NUMSOL AND SOLTRA_PAGFEC = 0"
   g_str_Parame = g_str_Parame & "                WHERE (SOLMAE_CODINS = 31 Or SOLMAE_CODINS = 32) And SOLMAE_SITUAC = 1"
   g_str_Parame = g_str_Parame & "                GROUP BY SOLMAE_CONHIP, SOLMAE_TIPMON) J ON J.SOLMAE_CONHIP = A.SOLMAE_CONHIP"
   g_str_Parame = g_str_Parame & "    LEFT JOIN (SELECT COUNT(*) AS CANGAS, SOLMAE_CONHIP, CASE WHEN SOLMAE_TIPMON = 1 THEN SUM(SOLMAE_MTOPRE_MPR) END AS MTOGAS_SOL,"
   ...
   Do While Not g_rst_Princi.EOF
      ...
      'Para obtener el Total Ingreso Mensual
      r_int_TotIng_Mes = Trim(g_rst_Princi!TOTING) 'ff_TotIng_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
      
      'Para obtener las solicitude en ev. cred. y ate. Comercial
      r_int_Pendie_Mes = g_rst_Princi!PENDIENTES 'ff_Pendie_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
      
      'Para obtener las solicitude rechazas o analuadas
      r_int_Rechaz_Mes = g_rst_Princi!RECHAZADAS 'ff_CanRec_Mes_ConHip(g_rst_Princi!SOLMAE_CONHIP)
      ...
      'Para la Obtencion de las solicitudes Aprobadas en Tramite
      r_int_AprCre_Tot = g_rst_Princi!CANPRE 'ff_AprCre_Tot_ConHip(g_rst_Princi!SOLMAE_CONHIP, r_dbl_MtoCre_Sol, r_dbl_MtoCre_Dol)
      r_dbl_MtoCre_Sol = g_rst_Princi!MTOPRE_SOL
      r_dbl_MtoCre_Dol = g_rst_Princi!MTOPRE_DOL
...
'   g_str_Parame = g_str_Parame & "ORDER BY SOLMAE_CODPRD ASC "
   ...
   Do While Not g_rst_Princi.EOF
      ...
      'Para obtener las solicitude rechazas o analuadas
      r_int_Rechaz_Mes = g_rst_Princi!RECHAZADAS 'ff_CanRec_Mes_TipPro(g_rst_Princi!SOLMAE_CODPRD)
      ...
      If r_str_Produc <> "" Then
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 1) = g_rst_Princi!PRODUC_DESCRI 'moddat_gf_Consulta_Produc(r_str_Produc)
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 2) = r_int_TotIng_Mes
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 3) = CStr(r_int_Pendie_Mes)
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 4) = CStr(r_int_Rechaz_Mes)
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 5) = CStr(r_int_TotDes_Mes)
...
Dim r_bol_CliNvo     As Boolean
   ...
   r_str_Cadena = r_str_Cadena & "        ,CASE WHEN (SOL.SOLMAE_SITUAC IN (1,2) AND SOL.SOLMAE_CODINS > 50 ) THEN (SELECT SEGUIM_FECFIN FROM TRA_SEGUIM WHERE SEGUIM_NUMSOL = SOLMAE_NUMERO AND SEGUIM_CODINS = 51) ELSE 0 END AS FEC_LEG "
   r_str_Cadena = r_str_Cadena & "        ,CASE WHEN (SOL.SOLMAE_SITUAC = 2 ) THEN HIPMAE_FECDES ELSE 0 END AS FEC_DES "
   ...
   r_str_Cadena = r_str_Cadena & " LEFT  JOIN CRE_HIPMAE  ON (HIPMAE_NUMSOL = SOLMAE_NUMERO) "
   ...
   With r_obj_Excel.ActiveSheet
      ...
      .Cells(r_int_NroFil, 2) = "FECHA SOLIC.":           .Columns("B").ColumnWidth = 14
      ...
      .Cells(r_int_NroFil, 6) = "MONTO":                  .Columns("F").ColumnWidth = 14
      .Cells(r_int_NroFil, 7) = "DNI":                    .Columns("G").ColumnWidth = 12
      ...
      .Cells(r_int_NroFil, 16) = "APROB. G.C":            .Columns("P").ColumnWidth = 12
      .Cells(r_int_NroFil, 17) = "F.APROB. LEGAL":        .Columns("Q").ColumnWidth = 15
      .Cells(r_int_NroFil, 18) = "F.DESEMBOLSO":          .Columns("R").ColumnWidth = 15
          
      .Range(.Cells(1, r_int_NroFil), .Cells(1, 18)).Font.Bold = True
      .Range(.Cells(1, r_int_NroFil), .Cells(1, 18)).HorizontalAlignment = xlHAlignCenter
   ...
   Do While Not g_rst_Princi.EOF
      ...
      If r_bol_CliNvo Then
         ...
         r_obj_Excel.ActiveSheet.Cells(r_int_NroFil, 17) = "'" & IIf(g_rst_Princi!FEC_LEG = 0, "", gf_FormatoFecha(g_rst_Princi!FEC_LEG))
         r_obj_Excel.ActiveSheet.Cells(r_int_NroFil, 18) = "'" & IIf(g_rst_Princi!FEC_DES = 0, "", gf_FormatoFecha(g_rst_Princi!FEC_DES))
         r_int_NroFil = r_int_NroFil + 1
      End If
...
'TOTAL DE INGRESOS DEL MES CORRESPONDIENTE
Private Function ff_TotIng_Mes_ConHip(ByVal p_ConHip As String) As Integer
   ff_TotIng_Mes_ConHip = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      g_rst_Listas.MoveFirst
      ff_TotIng_Mes_ConHip = g_rst_Listas!TOTING
   End If
...
'SOLICITUDES EN ATENCION COMERCIAL Y EVALUACION CREDITICIA DEL MES CORRESPONDIENTE (PENDIENTES)
Private Function ff_Pendie_Mes_ConHip(ByVal p_ConHip As String) As Integer
   ff_Pendie_Mes_ConHip = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_Pendie_Mes_ConHip = ff_Pendie_Mes_ConHip + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
'APROBADOS EN EVALUACION CREDITICIA DEL MES CORRESPONDIENTE
Private Function ff_AprCre_Mes_ConHip(ByVal p_ConHip As String) As Integer
   ff_AprCre_Mes_ConHip = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_AprCre_Mes_ConHip = ff_AprCre_Mes_ConHip + 1
         g_rst_Listas.MoveNext
      Loop
...
'APROBADOS GASTOS DE CIERRE DEL MES CORRESPONDINTE
Private Function ff_AprGas_Mes_ConHip(ByVal p_ConHip As String) As Integer
   ff_AprGas_Mes_ConHip = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_AprGas_Mes_ConHip = ff_AprGas_Mes_ConHip + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
'SOLICITUDES DESEMBOLSADOS EN EL MES CORRESPONDIENTE
Private Function ff_TotDes_Mes_ConHip(ByVal p_ConHip As String) As Integer
   ff_TotDes_Mes_ConHip = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_TotDes_Mes_ConHip = ff_TotDes_Mes_ConHip + 1
         g_rst_Listas.MoveNext
      Loop
   End If
...
'SOLICITUDES EN ATENCION COMERCIAL Y EVALUACION CREDITICIA A LA FECHA
Private Function ff_Pendie_Tot_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoPen_Sol As Double, Optional ByRef ff_MtoPen_Dol As Double) As Integer
   ff_Pendie_Tot_ConHip = 0
   ff_MtoPen_Sol = 0
   ff_MtoPen_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_Pendie_Tot_ConHip = ff_Pendie_Tot_ConHip + 1
...
'APROBACION DE EVALUACION CREDITICIA A LA FECHA
Private Function ff_AprCre_Tot_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoPre_Sol As Double, Optional ByRef ff_MtoPre_Dol As Double) As Integer
   ff_AprCre_Tot_ConHip = 0
   ff_MtoPre_Sol = 0
   ff_MtoPre_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_AprCre_Tot_ConHip = ff_AprCre_Tot_ConHip + 1
...
'APROBACION CON GASTOS DE CIERRE
Private Function ff_AprGas_Tot_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoGas_Sol As Double, Optional ByRef ff_MtoGas_Dol As Double) As Integer
   ff_AprGas_Tot_ConHip = 0
   ff_MtoGas_Sol = 0
   ff_MtoGas_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_AprGas_Tot_ConHip = ff_AprGas_Tot_ConHip + 1
...
'TRAMITE DE TASACION
Private Function ff_TraTas_Tot_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoTas_Sol As Double, Optional ByRef ff_MtoTas_Dol As Double) As Integer
   ff_TraTas_Tot_ConHip = 0
   ff_MtoTas_Sol = 0
   ff_MtoTas_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_TraTas_Tot_ConHip = ff_TraTas_Tot_ConHip + 1
...
'TRAMITE LEGAL
Private Function ff_TraLeg_Tot_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoLeg_Sol As Double, Optional ByRef ff_MtoLeg_Dol As Double) As Integer
   ff_TraLeg_Tot_ConHip = 0
   ff_MtoLeg_Sol = 0
   ff_MtoLeg_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_TraLeg_Tot_ConHip = ff_TraLeg_Tot_ConHip + 1
...
'OTROS TRAMITES DESPUES DE LA INSTANCIA DE LEGAL
Private Function ff_Otros_Tot_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoOtr_Sol As Double, Optional ByRef ff_MtoOtr_Dol As Double) As Integer
   ff_Otros_Tot_ConHip = 0
   ff_MtoOtr_Sol = 0
   ff_MtoOtr_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_Otros_Tot_ConHip = ff_Otros_Tot_ConHip + 1
...
'STOCK APROBADOS
Private Function ff_Stock_Tot_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoSto_Sol As Double, Optional ByRef ff_MtoSto_Dol As Double) As Integer
   ff_Stock_Tot_ConHip = 0
   ff_MtoSto_Sol = 0
   ff_MtoSto_Dol = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_Stock_Tot_ConHip = ff_Stock_Tot_ConHip + 1
...
'CANTIDAD DE SOLICITUDES DESEMBOLSADAS EN EL MES CORRESPONDIENTE
Private Function ff_CanDes_Mes_ConHip(ByVal p_ConHip As String, Optional ByRef ff_MtoDes_Sol As Double, Optional ByRef ff_MtoDes_Dol As Double) As Integer
   ff_CanDes_Mes_ConHip = 0
   ff_MtoDes_Sol = 0
   ff_MtoDes_Dol = 0
   ...
   g_str_Parame = g_str_Parame & "SELECT SOLMAE_TIPMON, SOLMAE_MTOPRE_MPR "
   g_str_Parame = g_str_Parame & "  FROM CRE_SOLMAE INNER JOIN CRE_HIPMAE ON SOLMAE_NUMERO = HIPMAE_NUMSOL "
   g_str_Parame = g_str_Parame & " WHERE SOLMAE_CONHIP = '" & Trim(p_ConHip) & "' AND "
   g_str_Parame = g_str_Parame & "       SOLMAE_SITUAC = 2 AND "
   g_str_Parame = g_str_Parame & "       HIPMAE_FECDES >= " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND "
   g_str_Parame = g_str_Parame & "       HIPMAE_FECDES <= " & Format(CDate(ipp_FecFin.Text), "yyyymmdd")
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_CanDes_Mes_ConHip = ff_CanDes_Mes_ConHip + 1
...
Private Function ff_CanRec_Mes_ConHip(ByVal p_ConHip As String) As Integer
   ff_CanRec_Mes_ConHip = 0
   ...
   If Not (g_rst_Listas.BOF And g_rst_Listas.EOF) Then
      ...
      Do While Not g_rst_Listas.EOF
         ff_CanRec_Mes_ConHip = ff_CanRec_Mes_ConHip + 1
         g_rst_Listas.MoveNext
      Loop
   End If
