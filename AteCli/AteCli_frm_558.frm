...
Begin VB.Form frm_IngPros_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Editar 
            Height          =   585
            Left            =   620
            Picture         =   "AteCli_frm_558.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmd_Agrega 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_558.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   7
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   14370
            Picture         =   "AteCli_frm_558.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   1215
            Picture         =   "AteCli_frm_558.frx":0A62
            Style           =   1  'Graphical
            TabIndex        =   9
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_558.frx":0D6C
            Top             =   60
            Width           =   480
         End
      End
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   8835
            Picture         =   "AteCli_frm_558.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   6
   ...
   End
End
Attribute VB_Name = "frm_IngPros_01"
...
Private Sub cmd_Agrega_Click()
    ...
    frm_IngPros_02.SSPanel7.Caption = frm_IngPros_02.SSPanel7.Caption & " - Insertar"
    frm_IngPros_02.Show 1
...
Private Sub cmd_Buscar_Click()
   ...
   g_str_Parame = g_str_Parame & "       PROCLI_NOMBRE, PROMAE_FECCON, PROMAE_PROYEC, PROCLI_NUMTEL, PROCLI_NUMCEL, PARDES_DESCRI "
   g_str_Parame = g_str_Parame & "  FROM CRE_PROMAE A "
   g_str_Parame = g_str_Parame & " INNER JOIN CRE_PROCLI B ON B.PROCLI_TIPDOC = A.PROMAE_TIPDOC AND B.PROCLI_NUMDOC = A.PROMAE_NUMDOC "
   g_str_Parame = g_str_Parame & "  LEFT JOIN MNT_PARDES D ON D.PARDES_CODGRP = '300' AND D.PARDES_CODITE = A.PROMAE_SITUAC "
   If modgen_g_int_TipUsu = 20121 Then   'Si Tipo de Usuario es Consejero Hipotecario
      If cmb_Situac.ItemData(cmb_Situac.ListIndex) <> 0 Then
         g_str_Parame = g_str_Parame & " WHERE A.PROMAE_CODCON = '" & modgen_g_str_CodUsu & "' AND PROMAE_FECCON > 0 AND "
         g_str_Parame = g_str_Parame & " PROMAE_SITUAC = '" & Format(cmb_Situac.ItemData(cmb_Situac.ListIndex), "000000") & "' "
         If chk_FecCon.Value = 0 Then
            g_str_Parame = g_str_Parame & " AND PROMAE_FECCON BETWEEN " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & ""
         End If
      Else
         g_str_Parame = g_str_Parame & " WHERE A.PROMAE_CODCON = '" & modgen_g_str_CodUsu & "' AND PROMAE_FECCON > 0 "
         If chk_FecCon.Value = 0 Then
            g_str_Parame = g_str_Parame & " AND PROMAE_FECCON BETWEEN " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & ""
         End If
      End If
   Else
      If cmb_Situac.ItemData(cmb_Situac.ListIndex) <> 0 Then
         g_str_Parame = g_str_Parame & " WHERE LENGTH(TRIM(A.PROMAE_CODCON)) > 0 AND PROMAE_FECCON > 0 AND PROMAE_SITUAC = '" & Format(cmb_Situac.ItemData(cmb_Situac.ListIndex), "000000") & "' "
         If chk_FecCon.Value = 0 Then
            g_str_Parame = g_str_Parame & " AND PROMAE_FECCON BETWEEN " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & ""
         End If
      Else
         g_str_Parame = g_str_Parame & " WHERE LENGTH(TRIM(A.PROMAE_CODCON)) > 0 AND PROMAE_FECCON > 0 "
         If chk_FecCon.Value = 0 Then
            g_str_Parame = g_str_Parame & " AND PROMAE_FECCON BETWEEN " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & ""
         End If
      End If
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 2
      grd_Listad.Text = "" & g_rst_Princi!PROMAE_PROYEC
      ...
      grd_Listad.Col = 4
      grd_Listad.Text = Right(CStr(g_rst_Princi!PROMAE_FECCON), 2) & "/" & Mid(CStr(g_rst_Princi!PROMAE_FECCON), 5, 2) & "/" & Left(CStr(g_rst_Princi!PROMAE_FECCON), 4)
      
      grd_Listad.Col = 5
      grd_Listad.Text = "" & Trim(g_rst_Princi!PARDES_DESCRI)
      
      grd_Listad.Col = 6
      grd_Listad.Text = Trim(g_rst_Princi!PROMAE_CODCON)
      
      grd_Listad.Col = 7
      grd_Listad.Text = g_rst_Princi!PROMAE_NUMSOL
...
Private Sub cmd_Editar_Click()
   ...
   frm_IngPros_02.SSPanel7.Caption = frm_IngPros_02.SSPanel7.Caption & " - Modificar"
   frm_IngPros_02.Show 1
...
Public Sub fs_Buscar()
   ...
   g_str_Parame = g_str_Parame & "SELECT PROMAE_NUMSOL, PROMAE_CODCON, PROCLI_TIPDOC, PROCLI_NUMDOC, PROCLI_APEPAT, PROCLI_APEMAT, "
   g_str_Parame = g_str_Parame & "       PROCLI_NOMBRE, PROMAE_FECCON, PROMAE_PROYEC, PROCLI_NUMTEL, PROCLI_NUMCEL, PARDES_DESCRI, "
   g_str_Parame = g_str_Parame & "       PROMAE_PROMOT, PROMAE_CONSTR"
   g_str_Parame = g_str_Parame & "  FROM CRE_PROMAE A"
   g_str_Parame = g_str_Parame & " INNER JOIN CRE_PROCLI B ON B.PROCLI_TIPDOC = A.PROMAE_TIPDOC AND B.PROCLI_NUMDOC = A.PROMAE_NUMDOC "
   g_str_Parame = g_str_Parame & "  LEFT JOIN MNT_PARDES D ON D.PARDES_CODGRP = '300' AND D.PARDES_CODITE = A.PROMAE_SITUAC "
   If modgen_g_int_TipUsu = 20121 Then   'Si Tipo de Usuario es Consejero Hipotecario
      g_str_Parame = g_str_Parame & " WHERE A.PROMAE_CODCON = '" & modgen_g_str_CodUsu & "' AND A.PROMAE_FECCON > 0 AND A.PROMAE_SITUAC = '000001' "
   Else
      g_str_Parame = g_str_Parame & " WHERE LENGTH(TRIM(A.PROMAE_CODCON)) > 0 AND A.PROMAE_FECCON > 0 AND A.PROMAE_SITUAC = '000001' "
   End If
   
   If grd_Listad.Tag = 1 Then
      If chk_ConHip.Value = 0 Then
         g_str_Parame = g_str_Parame & " AND PROMAE_FECCON BETWEEN " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & ""
         g_str_Parame = g_str_Parame & " AND PROMAE_CODCON='" & l_arr_ConHip(cmb_ConHip.ListIndex + 1).Genera_Codigo & "'"
      End If
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 8
      grd_Listad.Text = g_rst_Princi!PROMAE_FECCON
...
Dim r_obj_Excel      As Excel.Application
   ...
   g_str_Parame = ""
   g_str_Parame = g_str_Parame & "SELECT PROMAE_NUMSOL, PROMAE_CODCON, PROCLI_TIPDOC, PROCLI_NUMDOC, PROCLI_APEPAT, PROCLI_APEMAT, PROCLI_NOMBRE, "
   g_str_Parame = g_str_Parame & "       PROMAE_FECCON, PROMAE_PROYEC, PROCLI_NUMTEL, PROCLI_NUMCEL, PARDES_DESCRI, PROMAE_COMMENT, PROMAE_PROMOT, PROMAE_CONSTR "
   g_str_Parame = g_str_Parame & "  FROM CRE_PROMAE A"
   g_str_Parame = g_str_Parame & " INNER JOIN CRE_PROCLI B ON B.PROCLI_TIPDOC = A.PROMAE_TIPDOC AND B.PROCLI_NUMDOC = A.PROMAE_NUMDOC "
   g_str_Parame = g_str_Parame & "  LEFT JOIN MNT_PARDES D ON D.PARDES_CODGRP = '300' AND D.PARDES_CODITE = A.PROMAE_SITUAC "
   If modgen_g_int_TipUsu = 20121 Then  'Si Tipo de Usuario es Consejero Hipotecario
      If cmb_Situac.ItemData(cmb_Situac.ListIndex) <> 0 Then
         g_str_Parame = g_str_Parame & " WHERE A.PROMAE_CODCON = '" & modgen_g_str_CodUsu & "' AND PROMAE_FECCON > 0 AND PROMAE_SITUAC = '" & Format(cmb_Situac.ItemData(cmb_Situac.ListIndex), "000000") & "' "
      Else
         g_str_Parame = g_str_Parame & " WHERE A.PROMAE_CODCON = '" & modgen_g_str_CodUsu & "' AND PROMAE_FECCON > 0 "
      End If
   Else
   ...
   If chk_FecCon.Value = 0 Then
      g_str_Parame = g_str_Parame & " AND A.PROMAE_FECCON BETWEEN " & Format(CDate(ipp_FecIni.Text), "yyyymmdd") & " AND " & Format(CDate(ipp_FecFin.Text), "yyyymmdd") & ""
   End If
   ...
   With r_obj_Excel.ActiveSheet
      'Unir celdas
      .Range("B5") = "LISTADO DE PROSPECTOS"
   ...
   Do While Not g_rst_Princi.EOF
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad + 3) = Trim(g_rst_Princi!PROMAE_PROYEC)
      If Len(Trim(g_rst_Princi!PROCLI_NUMTEL)) > 0 Then
      ...
      End If
      r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad + 5) = "'" & Right(CStr(g_rst_Princi!PROMAE_FECCON), 2) & "/" & Mid(CStr(g_rst_Princi!PROMAE_FECCON), 5, 2) & "/" & Left(CStr(g_rst_Princi!PROMAE_FECCON), 4)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad + 6) = Trim(g_rst_Princi!PARDES_DESCRI)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad + 7) = Trim(g_rst_Princi!PROMAE_CODCON)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad + 8) = Trim(g_rst_Princi!PROMAE_COMMENT)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad + 9) = Trim(g_rst_Princi!PROMAE_PROMOT)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConAux, r_int_Contad + 10) = Trim(g_rst_Princi!PROMAE_CONSTR)
