...
Begin VB.Form frm_SegSol_60 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin TabDlg.SSTab tab_Seguim 
            ...
            TabPicture(0)   =   "AteCli_frm_166.frx":000C
            ...
            TabPicture(1)   =   "AteCli_frm_166.frx":0028
            ...
            TabPicture(2)   =   "AteCli_frm_166.frx":0044
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_166.frx":0074
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   10920
            Picture         =   "AteCli_frm_166.frx":037E
            Style           =   1  'Graphical
            TabIndex        =   43
            ToolTipText     =   "Salir"
            Top             =   30
         ...
         Begin VB.CommandButton cmd_NueObs 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_166.frx":07C0
            Style           =   1  'Graphical
            TabIndex        =   42
   ...
   End
End
Attribute VB_Name = "frm_SegSol_60"
...
Private Sub fs_Envia_CorEle(ByVal p_Asunto As String, ByVal p_Mensaje As String)
   ...
   r_str_Cadena = moddat_gf_UsuObs(moddat_g_str_NumSol, 62)
   ReDim Preserve moddat_g_arr_Genera(UBound(moddat_g_arr_Genera) + 1)
