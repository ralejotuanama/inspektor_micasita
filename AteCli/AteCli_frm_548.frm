...
Begin VB.Form frm_Con_CreHip_59 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_548.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6540
            Picture         =   "AteCli_frm_548.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   3
            Top             =   30
            Width           =   585
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_548.frx":0890
            Top             =   60
            Width           =   480
         End
      End
   ...
   End
End
Attribute VB_Name = "frm_Con_CreHip_59"
...
Private Sub cmd_Imprim_Click()
   ...
   g_str_Parame = g_str_Parame & "ECTACB_NOMRPT = 'OPE_ESTCTA_03.RPT' "
   ...
   g_str_Parame = g_str_Parame & "ECTADT_NOMRPT = 'OPE_ESTCTA_03.RPT' "
   
   If Not gf_EjecutaSQL(g_str_Parame, g_rst_Princi, 2) Then
       Exit Sub
   End If
   
   Call opecaj_gs_EstCta(moddat_g_str_NumOpe, Format(CDate(ipp_FecIni.Text), "yyyymmdd"), Format(CDate(ipp_FecFin.Text), "yyyymmdd"), "OPE_ESTCTA_03.RPT")
   ...
   crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "OPE_ESTCTA_03.RPT"
        
   crp_Imprim.SelectionFormula = "{RPT_ECTADT.ECTADT_NOMRPT} = 'OPE_ESTCTA_03.RPT' AND "
