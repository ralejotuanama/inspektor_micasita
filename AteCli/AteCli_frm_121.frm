...
Begin VB.Form frm_SimCre_01 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel5 
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   675
            Left            =   10020
            Picture         =   "AteCli_frm_121.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   13
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   675
            Left            =   9330
            Picture         =   "AteCli_frm_121.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   12
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   675
            Left            =   10710
            Picture         =   "AteCli_frm_121.frx":0620
            Style           =   1  'Graphical
            TabIndex        =   14
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_121.frx":0A62
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel39 
         ...
         Begin VB.CommandButton cmd_Grabar 
            Height          =   675
            Left            =   10710
            Picture         =   "AteCli_frm_121.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   32
      ...
      Begin Threed.SSPanel SSPanel9 
         ...
         Begin VB.CommandButton cmd_Calcul 
            Height          =   675
            Left            =   30
            Picture         =   "AteCli_frm_121.frx":11AE
            Style           =   1  'Graphical
            TabIndex        =   92
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   675
            Left            =   10710
            Picture         =   "AteCli_frm_121.frx":14B8
            Style           =   1  'Graphical
            TabIndex        =   91
   ...
   End
End
Attribute VB_Name = "frm_SimCre_01"
...
Private Sub cmd_Imprim_Click()
   ...
   moddat_g_bdt_Report.Execute "DELETE FROM RPT_SIMCRE"
   DoEvents
                        
   'Grabando en DAO
   moddat_g_str_CadDAO = "SELECT * FROM RPT_SIMCRE WHERE SIMCRE_PRODUC = '" & l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Nombre & "'"
   Set moddat_g_rst_RecDAO = moddat_g_bdt_Report.OpenRecordset(moddat_g_str_CadDAO, dbOpenDynaset)


   moddat_g_rst_RecDAO.AddNew
                        
   moddat_g_rst_RecDAO("SIMCRE_PRODUC") = l_arr_Produc(cmb_Produc.ListIndex + 1).Genera_Nombre
   moddat_g_rst_RecDAO("SIMCRE_MONEDA") = moddat_gf_Consulta_ParDes("204", l_int_TipMon)
   moddat_g_rst_RecDAO("SIMCRE_SIMMON") = moddat_gf_Consulta_ParDes("229", l_int_TipMon)
   moddat_g_rst_RecDAO("SIMCRE_COMVTA") = ipp_ComVta.Value
   moddat_g_rst_RecDAO("SIMCRE_MTOPRE") = ipp_MtoPre.Value
   moddat_g_rst_RecDAO("SIMCRE_PLAANO") = ipp_PlaAno.Value
   moddat_g_rst_RecDAO("SIMCRE_PERGRA") = ipp_PerGra.Value
   moddat_g_rst_RecDAO("SIMCRE_CUOEXT") = "NO"
   moddat_g_rst_RecDAO("SIMCRE_DIAPAG") = CInt(l_arr_DiaPag(cmb_DiaPag.ListIndex + 1).Genera_Codigo)
   moddat_g_rst_RecDAO("SIMCRE_TIPSEG") = cmb_TipSeg.Text
   
   moddat_g_rst_RecDAO("SIMCRE_TASINT") = CDbl(pnl_TasInt.Caption)
   moddat_g_rst_RecDAO("SIMCRE_SEGDES") = l_dbl_SegDes
   moddat_g_rst_RecDAO("SIMCRE_SEGINM") = l_dbl_SegInm
   moddat_g_rst_RecDAO("SIMCRE_PORTES") = l_dbl_Portes
   
   moddat_g_rst_RecDAO("SIMCRE_CUOMEN") = CDbl(pnl_CuoMen.Caption)
   moddat_g_rst_RecDAO("SIMCRE_CUOPAG") = CDbl(pnl_Hog_CuoPag.Caption)
   moddat_g_rst_RecDAO("SIMCRE_INGREQ") = CDbl(pnl_IngSol.Caption)
   moddat_g_rst_RecDAO("SIMCRE_INGMPR") = CDbl(pnl_IngMPr.Caption)
   moddat_g_rst_RecDAO("SIMCRE_TIPCAM") = CDbl(pnl_TipCam.Caption)
                        
   moddat_g_rst_RecDAO.Update
   moddat_g_rst_RecDAO.Close
   
   If UCase(App.EXEName) = "EVACRE" Then
      crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "COM_SIMCRE_02.RPT"
   Else
      crp_Imprim.ReportFileName = g_str_RutRpt & "\" & "COM_SIMCRE_01.RPT"
   End If
