...
Begin VB.Form frm_RptSol_17 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_520.frx":000C
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel4 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   6960
            Picture         =   "AteCli_frm_520.frx":0316
            Style           =   1  'Graphical
            TabIndex        =   8
         ...
         Begin VB.CommandButton cmd_Imprim 
            Height          =   585
            Left            =   30
            Picture         =   "AteCli_frm_520.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   6
         ...
         Begin VB.CommandButton cmd_ExpExc 
            Height          =   585
            Left            =   630
            Picture         =   "AteCli_frm_520.frx":0B9A
            Style           =   1  'Graphical
            TabIndex        =   7
   ...
   End
End
Attribute VB_Name = "frm_RptSol_17"
...
Private Sub fs_GenExc()
   ...
   g_str_Parame = "SELECT * FROM CRE_SOLMAE A, PRY_DATGEN B, CRE_SOLINM C, CLI_DATGEN D WHERE "
   ...
   Do While Not g_rst_Princi.EOF
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 5) = moddat_gf_Consulta_Produc(g_rst_Princi!SOLMAE_CODPRD)
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 8) = moddat_gf_Buscar_NomCli(CStr(g_rst_Princi!SOLMAE_TITTDO), Trim(g_rst_Princi!SOLMAE_TITNDO))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 9) = CDate(gf_FormatoFecha(CStr(g_rst_Princi!SOLMAE_FECSOL)))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 10) = moddat_gf_Consulta_ParDes("002", CStr(g_rst_Princi!SOLMAE_CODINS))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 11) = moddat_gf_Consulta_ParDes("004", CStr(g_rst_Princi!SOLMAE_SITINS))
