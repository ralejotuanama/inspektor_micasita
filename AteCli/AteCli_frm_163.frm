...
Begin VB.Form frm_ConSol_49 
   ...
   Begin Threed.SSPanel SSPanel1 
      ...
      Begin Threed.SSPanel SSPanel3 
         ...
         Begin VB.CommandButton cmd_Salida 
            Height          =   585
            Left            =   7410
            Picture         =   "AteCli_frm_163.frx":000C
            Style           =   1  'Graphical
            TabIndex        =   4
         ...
         Begin VB.CommandButton cmd_Buscar 
            Height          =   585
            Left            =   6210
            Picture         =   "AteCli_frm_163.frx":044E
            Style           =   1  'Graphical
            TabIndex        =   2
         ...
         Begin VB.CommandButton cmd_Limpia 
            Height          =   585
            Left            =   6810
            Picture         =   "AteCli_frm_163.frx":0758
            Style           =   1  'Graphical
            TabIndex        =   3
      ...
      Begin Threed.SSPanel SSPanel6 
         ...
         Begin VB.Image Image1 
            Height          =   480
            Left            =   60
            Picture         =   "AteCli_frm_163.frx":0A62
            Top             =   60
            Width           =   480
         End
      End
      Begin Threed.SSPanel SSPanel2 
         ...
         Begin VB.CommandButton cmd_BusCli 
            Height          =   585
            Left            =   6810
            Picture         =   "AteCli_frm_163.frx":0D6C
            Style           =   1  'Graphical
            TabIndex        =   9
         ...
         Begin VB.CommandButton cmd_LimBus 
            Height          =   585
            Left            =   7410
            Picture         =   "AteCli_frm_163.frx":1076
            Style           =   1  'Graphical
            TabIndex        =   10
   ...
   End
End
Attribute VB_Name = "frm_ConSol_49"
...
Private Sub cmd_Buscar_Click()
   ...
   Do While Not g_rst_Princi.EOF
      ...
      grd_Listad.Col = 6
      grd_Listad.Text = CStr(g_rst_Princi!SOLMAE_SITUAC)
...
Private Sub cmd_SegSol_Click()
   ...
   If modgen_g_int_TipUsu = 20121 Then
      If Trim(r_str_ConHip) <> moddat_gf_Buscar_CodEje_UsuSis(modgen_g_str_CodUsu) Then
         MsgBox "No puede realizar el Seguimiento de este cliente porque pertenece a otro Consejero Hipotecario.", vbInformation, modgen_g_str_NomPlt
         Exit Sub
      End If
   End If
...
Private Sub grd_Listad_DblClick()
   ...
   'If r_int_Situac = 1 And (modgen_g_int_TipUsu <> 20900 Or modgen_g_int_TipUsu = 1000) Then
   '   If modgen_g_int_TipUsu = 20121 Then
   '      If Trim(r_str_ConHip) <> moddat_gf_Buscar_CodEje_UsuSis(modgen_g_str_CodUsu) Then
