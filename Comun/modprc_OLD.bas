            ...
            If r_int_FlgEnc = 1 Then
               ...
               If ff_Valida_RCCCab(CInt(r_str_TipDoc), r_str_NumDoc, p_PerMes, p_PerAno) Then
                  ...
                  Do While Not EOF(r_int_NumFil) And r_str_CarPos = Mid(r_str_LineaL, 1, 1)
                     If (Mid(r_str_LineaL, 19, 2) = "14" And CStr(CLng(Mid(r_str_LineaL, 12, 5))) <> 240 And Mid(r_str_LineaL, 19, 4) <> "1418" And _
                         Mid(r_str_LineaL, 19, 4) <> "1428" And Mid(r_str_LineaL, 19, 4) <> "1419" And Mid(r_str_LineaL, 19, 4) <> "1429") Or _
                        (Mid(r_str_LineaL, 19, 6) = "811302" Or Mid(r_str_LineaL, 19, 6) = "812302" Or _
                         ...
                         Mid(r_str_LineaL, 19, 6) = "811922" Or Mid(r_str_LineaL, 19, 6) = "812922") Then
                  ...
                  If Not ff_Actualiza_CodigoSBS(CInt(r_str_TipDoc), r_str_NumDoc, r_str_CodSbs, 1) Then
                     r_lng_NumErr = r_lng_NumErr + 1
               ...
               If ff_Valida_RCCCab(7, r_str_NumRuc, p_PerMes, p_PerAno) Then
                  ...
                  Do While Not EOF(r_int_NumFil) And r_str_CarPos = Mid(r_str_LineaL, 1, 1)
                     If Mid(r_str_LineaL, 19, 2) = "14" And CStr(CLng(Mid(r_str_LineaL, 12, 5))) <> 240 And Mid(r_str_LineaL, 19, 4) <> "1418" And _
                        ...
                        Mid(r_str_LineaL, 19, 6) = "812922" Or Mid(r_str_LineaL, 19, 6) = "811922") Then
   ...
   If Not (modprc_g_rst_Princi.BOF And modprc_g_rst_Princi.EOF) Then
      ...
      Do While Not modprc_g_rst_Princi.EOF
       ...
       r_dbl_Mes_IntEfe = r_rst_Genera!HIPPAG_INTERE
         ...
         If ff_Valida_OperacionGNB(Trim(modprc_g_rst_Princi!CAJMOV_NUMOPE)) Then
            'Operaciones GNB
...
Dim r_int_TipGar        As Integer
   ...
   'modprc_g_str_CadEje = modprc_g_str_CadEje & " AND HIPCIE_NUMOPE = '0030700002'"
   ...
   If Not (modprc_g_rst_Princi.BOF And modprc_g_rst_Princi.EOF) Then
      ...
      Do While Not modprc_g_rst_Princi.EOF
         ...
         If modprc_g_rst_Princi!HIPCIE_CLACLI = 3 Then
            modprc_g_str_CadEje = ""
            modprc_g_str_CadEje = modprc_g_str_CadEje & "SELECT DISTINCT HIPCIE_CLAPRV, COUNT(*) AS CONTADOR "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "  FROM (SELECT HIPCIE_PERANO, HIPCIE_PERMES, HIPCIE_CLAPRV "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "          FROM CRE_HIPCIE "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "         WHERE HIPCIE_PERMES > 0 "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "           AND HIPCIE_PERANO > 2010 "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "           AND HIPCIE_NUMOPE = '" & modprc_g_rst_Princi!HIPCIE_NUMOPE & "' "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "           AND HIPCIE_CLAPRV = 3 "
            ...
            modprc_g_str_CadEje = modprc_g_str_CadEje & " GROUP BY HIPCIE_CLAPRV "
         ...
         If modprc_g_rst_Princi!HIPCIE_CLACLI = 4 Then
            ...
            modprc_g_str_CadEje = modprc_g_str_CadEje & "          FROM CRE_HIPCIE "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "         WHERE HIPCIE_PERMES > 0 "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "           AND HIPCIE_PERANO > 2009 "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "           AND HIPCIE_NUMOPE = '" & modprc_g_rst_Princi!HIPCIE_NUMOPE & "' "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "           AND HIPCIE_CLAPRV = 4 "
            modprc_g_str_CadEje = modprc_g_str_CadEje & "         ORDER BY HIPCIE_PERANO DESC, HIPCIE_PERMES DESC) "
         ...
         'A. Determinando Clase de Garantía según Tipo de Garantía
         r_int_ClaGar = 0
...
'         'CALCULA EL VALOR COMERCIAL
'         r_dbl_ValCom = 0
'         r_int_MonCom = 0
'
'         modprc_g_str_CadEje = ""
'         modprc_g_str_CadEje = modprc_g_str_CadEje & "SELECT EVATAS_TIPMON AS MONEDA, ROUND(DECODE(EVATAS_TIPMON, 1, (EVATAS_VALCOM_INM+EVATAS_VALCOM_ES1+EVATAS_VALCOM_ES2+EVATAS_VALCOM_DEP) / EVATAS_TIPCAM, (EVATAS_VALCOM_INM+EVATAS_VALCOM_ES1+EVATAS_VALCOM_ES2+EVATAS_VALCOM_DEP)), 2) AS MONTO "
...
'         If Not (r_rst_PrvTim.BOF And r_rst_PrvTim.EOF) Then
'            r_rst_PrvTim.MoveFirst
'            r_int_MonCom = r_rst_PrvTim!Moneda
'            If r_int_MonCom = 1 Then
'               r_dbl_ValCom = Format(r_rst_PrvTim!MONTO * modprc_g_rst_Princi!HIPCIE_TIPCAM, "###,###,##0.00")
'            Else
'               r_dbl_ValCom = Format(r_rst_PrvTim!MONTO, "###,###,##0.00")
'            End If
'         End If
'
'         r_rst_PrvTim.Close
...
'         'OTROS GASTOS (SE SUMARA A LOS GASTOS JUDICIALES)
'         r_dbl_OtrGas = 0
'         r_dbl_OtrGas = modprc_g_rst_Princi!HIPCIE_ACUDVG
'
'         If modprc_g_rst_Princi!HIPCIE_FLGREF = 0 Then
'            r_dbl_OtrGas = r_dbl_OtrGas + modprc_g_rst_Princi!HIPCIE_ACUDVC
'         ElseIf modprc_g_rst_Princi!HIPCIE_ACUDVC > 0 Then
'            r_dbl_OtrGas = r_dbl_OtrGas + modprc_g_rst_Princi!HIPCIE_ACUDVC
'         Else
'            r_dbl_OtrGas = r_dbl_OtrGas + modprc_g_rst_Princi!HIPCIE_ACUDVG
'         End If
         
'         r_dbl_GtoJud = modprc_ff_CalculaGastosJudicial(modprc_g_rst_Princi!HIPCIE_CODPRD, modprc_g_rst_Princi!HIPCIE_CODSUB, (modprc_g_rst_Princi!HIPCIE_SALCAP + modprc_g_rst_Princi!HIPCIE_SALCON), modprc_g_rst_Princi!HIPCIE_TIPMON, modprc_g_rst_Princi!HIPCIE_TIPCAM, modprc_g_rst_Princi!HIPCIE_TIPGAR, r_dbl_ValCom, r_int_MonCom)
'         r_dbl_GtoJud = r_dbl_GtoJud + r_dbl_OtrGas
         
'         r_dbl_PerFmv = 0
'         Call modprc_ff_CalculaMontosBaseProv2(r_dbl_PerFmv, r_dbl_MtoCga, r_dbl_MtoSga, r_dbl_GtoJud, modprc_g_rst_Princi!HIPCIE_SALCAP, modprc_g_rst_Princi!HIPCIE_SALCON, modprc_g_rst_Princi!HIPCIE_CODPRD, modprc_g_rst_Princi!HIPCIE_TIPMON, modprc_g_rst_Princi!HIPCIE_TIPCAM, modprc_g_rst_Princi!HIPCIE_FECDES, modprc_g_rst_Princi!HIPCIE_TIPGAR, r_dbl_ValCom, r_int_MonCom, modprc_g_rst_Princi!HIPCIE_INTDIF)
         ...
         'C. Si Clasificacion del deudor es normal
         If modprc_g_rst_Princi!HIPCIE_CLAPRV = 0 Then
            ...
            If modprc_g_rst_Princi!HIPCIE_FECDES > 20100630 Then
               If r_int_TipGar = 1 Or r_int_TipGar = 2 Then
                  If modprc_g_rst_Princi!HIPCIE_CODPRD = "007" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "009" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "010" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "013" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "014" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "015" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "016" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "017" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "018" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "019" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "021" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "022" Or modprc_g_rst_Princi!HIPCIE_CODPRD = "023" Then
         ...
         'D. Si Clasificacion del deudor es diferente de normal
         If modprc_g_rst_Princi!HIPCIE_CLAPRV <> 0 Then
        ...
        End If
         ...
         If modprc_g_rst_Princi!HIPCIE_FECDES < 20100701 Then
            If modprc_g_rst_Princi!HIPCIE_TIPGAR = 1 Or modprc_g_rst_Princi!HIPCIE_TIPGAR = 2 Or modprc_g_rst_Princi!HIPCIE_TIPGAR = 4 Then
               ...
               Select Case modprc_g_rst_Princi!HIPCIE_CODPRD
                      Case "004", "007", "009", "010", "012", "013", "014", "015", "016", "017", "018", "019", "021", "022", "023"
         ...
         If modprc_g_rst_Princi!HIPCIE_FECDES >= 20100701 Then
             If modprc_g_rst_Princi!HIPCIE_TIPGAR = 1 Or modprc_g_rst_Princi!HIPCIE_TIPGAR = 2 Then
                Select Case modprc_g_rst_Princi!HIPCIE_CODPRD
                       Case "004", "007", "009", "010", "012", "013", "014", "015", "016", "017", "018", "019", "021", "022", "023"
         ...
         'C. Actualizando Provisión en CRE_HIPCIE
         modprc_g_str_CadEje = "UPDATE CRE_HIPCIE " & _
...
Dim r_int_FlgRef        As Integer
   ...
   If Not (modprc_g_rst_Princi.BOF And modprc_g_rst_Princi.EOF) Then
      ...
      Do While Not modprc_g_rst_Princi.EOF
         ...
         If modprc_g_rst_Princi!HIPMAE_CODPRD = "003" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "004" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "007" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "009" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "010" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "013" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "014" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "015" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "016" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "017" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "018" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "019" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "021" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "022" Or modprc_g_rst_Princi!HIPMAE_CODPRD = "023" Then
...
Dim r_dbl_PerdidaMic    As Double
   ...
   If Not (p_TipGar = 1 Or p_TipGar = 2) Then
...
Public Function ff_Valida_OperacionGNB(ByVal p_NumOpe As String) As Boolean
