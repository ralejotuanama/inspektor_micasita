...
Public modmip_g_int_Filtro_Sit   As Integer
...
Dim r_str_CadBon     As String

   modmip_g_int_DiaMor = 0
   Call gs_LimpiaGrid(p_Grid)
   ReDim r_arr_Mtz(0)
    
   If Trim(moddat_g_str_NumSol) <> "" Then
      g_str_Parame = ""
   ...
   If IsNull(moddat_g_str_NumOpe) Or moddat_g_str_NumOpe = "" Then
      g_str_Parame = ""
      g_str_Parame = g_str_Parame & " SELECT A.*, B.DATGEN_PAIRES, DATGEN_NDOACC, DATGEN_TDOACC, DATGEN_ACCVIN, DATGEN_NDOVIN, DATGEN_TDOVIN, DATGEN_TIPVIN  "
      g_str_Parame = g_str_Parame & "   FROM CRE_SOLMAE A  "
      g_str_Parame = g_str_Parame & "  INNER JOIN CLI_DATGEN B ON DATGEN_TIPDOC = A.SOLMAE_TITTDO AND TRIM(DATGEN_NUMDOC) = TRIM(A.SOLMAE_TITNDO)  "
      g_str_Parame = g_str_Parame & "  WHERE A.SOLMAE_NUMERO = '" & moddat_g_str_NumSol & "' "
   Else
      g_str_Parame = ""
      g_str_Parame = g_str_Parame & "SELECT A.*, B.*, DATGEN_PAIRES, DATGEN_NDOACC, DATGEN_TDOACC, DATGEN_ACCVIN, DATGEN_NDOVIN, DATGEN_TDOVIN, DATGEN_TIPVIN "
      ...
      g_str_Parame = g_str_Parame & " INNER JOIN CLI_DATGEN C ON DATGEN_TIPDOC = SOLMAE_TITTDO AND TRIM(DATGEN_NUMDOC) = TRIM(SOLMAE_TITNDO)  "
      g_str_Parame = g_str_Parame & " WHERE HIPMAE_NUMOPE = '" & moddat_g_str_NumOpe & "' "
      If modmip_g_int_Filtro_Sit = 1 Then
   ...
   r_str_CadBon = IIf(g_rst_Princi!SOLMAE_CODPRD = "024", "Importe BFH", IIf(g_rst_Princi!SOLMAE_CODPRD = "021" Or g_rst_Princi!SOLMAE_CODPRD = "022", "Importe BBP", ""))
   If IsNull(moddat_g_str_NumOpe) Or moddat_g_str_NumOpe = "" Then
      'NUMERO DE SOLICITUD
      p_Grid.Rows = p_Grid.Rows + 1:      p_Grid.Row = p_Grid.Rows - 1
      ...
      If g_rst_Princi!SOLMAE_COMVTA_SOL > 0 Then
         ...
         p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & IIf(g_rst_Princi!SOLMAE_TIPMON = 1, gf_FormatoNumero(g_rst_Princi!SOLMAE_COMVTA_SOL, 12, 2), gf_FormatoNumero(g_rst_Princi!SOLMAE_COMVTA_DOL, 12, 2))
         
         If Not IsNull(g_rst_Princi!SOLMAE_MTOINM) And g_rst_Princi!SOLMAE_MTOINM <> 0 Then
            p_Grid.Rows = p_Grid.Rows + 1: p_Grid.Row = p_Grid.Rows - 1
            p_Grid.Col = 0:                    p_Grid.Text = "                Importe Inmueble"
            p_Grid.Col = 1:                    p_Grid.CellFontName = "Lucida Console"
            p_Grid.CellFontSize = 8:           p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & gf_FormatoNumero(IIf(IsNull(g_rst_Princi!SOLMAE_MTOINM), 0, g_rst_Princi!SOLMAE_MTOINM), 12, 2)
         End If
         
         If Not IsNull(g_rst_Princi!SOLMAE_MTOEST) And g_rst_Princi!SOLMAE_MTOEST <> 0 Then
            p_Grid.Rows = p_Grid.Rows + 1: p_Grid.Row = p_Grid.Rows - 1
            p_Grid.Col = 0:                    p_Grid.Text = "                Importe Estacionamiento"
            p_Grid.Col = 1:                    p_Grid.CellFontName = "Lucida Console"
            p_Grid.CellFontSize = 8:           p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & gf_FormatoNumero(IIf(IsNull(g_rst_Princi!SOLMAE_MTOEST), 0, g_rst_Princi!SOLMAE_MTOEST), 12, 2)
         End If
   
         p_Grid.Rows = p_Grid.Rows + 1:    p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                       p_Grid.Text = "Cuota Inicial"
         p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
         If g_rst_Princi!SOLMAE_CODPRD = "023" Then
            p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & IIf(g_rst_Princi!SOLMAE_TIPMON = 1, gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_SOL, 12, 2), gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_DOL, 12, 2)) & " (" & Format((IIf(g_rst_Princi!SOLMAE_TIPMON = 1, CDbl(g_rst_Princi!SOLMAE_APOPRO_SOL), CDbl(g_rst_Princi!SOLMAE_APOPRO_DOL))) / IIf(g_rst_Princi!SOLMAE_TIPMON = 1, CDbl(g_rst_Princi!SOLMAE_COMVTA_SOL), CDbl(g_rst_Princi!SOLMAE_COMVTA_DOL)) * 100, "##0.00") & "%)"
         Else
            p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & IIf(g_rst_Princi!SOLMAE_TIPMON = 1, gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_SOL, 12, 2), gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_DOL, 12, 2)) & " (" & Format((IIf(g_rst_Princi!SOLMAE_TIPMON = 1, CDbl(g_rst_Princi!SOLMAE_APOPRO_SOL), CDbl(g_rst_Princi!SOLMAE_APOPRO_DOL)) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_FMVBBP), 0, g_rst_Princi!SOLMAE_FMVBBP)) - CDbl(g_rst_Princi!SOLMAE_PBPMTO) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_BMSMTO), 0, g_rst_Princi!SOLMAE_BMSMTO))) / IIf(g_rst_Princi!SOLMAE_TIPMON = 1, CDbl(g_rst_Princi!SOLMAE_COMVTA_SOL), CDbl(g_rst_Princi!SOLMAE_COMVTA_DOL)) * 100, "##0.00") & "%)"
         End If
         
         p_Grid.Rows = p_Grid.Rows + 1: p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                    p_Grid.Text = "                Aporte Propio"
         p_Grid.Col = 1:                    p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:           p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & gf_FormatoNumero(CDbl(IIf(g_rst_Princi!SOLMAE_TIPMON = 1, g_rst_Princi!SOLMAE_APOPRO_SOL, g_rst_Princi!SOLMAE_APOPRO_DOL)) - (CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_FMVBBP), 0, g_rst_Princi!SOLMAE_FMVBBP)) + CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_PBPMTO), 0, g_rst_Princi!SOLMAE_PBPMTO))) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_BMSMTO), 0, g_rst_Princi!SOLMAE_BMSMTO)) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_AFPMTO), 0, g_rst_Princi!SOLMAE_AFPMTO)), 12, 2)
   
         'ADICION NUEVA PBP
         If Not IsNull(g_rst_Princi!SOLMAE_PBPMTO) And g_rst_Princi!SOLMAE_PBPMTO <> 0 Then
            p_Grid.Rows = p_Grid.Rows + 1: p_Grid.Row = p_Grid.Rows - 1
            p_Grid.Col = 0:                    p_Grid.Text = "                Importe PBP"
            p_Grid.Col = 1:                    p_Grid.CellFontName = "Lucida Console"
            p_Grid.CellFontSize = 8:           p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & gf_FormatoNumero(IIf(IsNull(g_rst_Princi!SOLMAE_PBPMTO), 0, g_rst_Princi!SOLMAE_PBPMTO), 12, 2)
         End If
         ...
         If Not IsNull(g_rst_Princi!SOLMAE_PREMTO) And g_rst_Princi!SOLMAE_PREMTO <> 0 Then
            p_Grid.Rows = p_Grid.Rows + 1:    p_Grid.Row = p_Grid.Rows - 1
            p_Grid.Col = 0:                       p_Grid.Text = "Monto Préstamo"
            p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
            p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_PREMTO, 12, 2)
         End If
         If Not IsNull(g_rst_Princi!SOLMAE_MTOGCI) And g_rst_Princi!SOLMAE_MTOGCI <> 0 Then
            p_Grid.Rows = p_Grid.Rows + 1:    p_Grid.Row = p_Grid.Rows - 1
            p_Grid.Col = 0:                       p_Grid.Text = "Gasto Cierre"
            p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
            p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_MTOGCI, 12, 2)
         End If
         
         p_Grid.Rows = p_Grid.Rows + 1:    p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                       p_Grid.Text = "Total Préstamo"
         p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(g_rst_Princi!SOLMAE_TIPMON)) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_MTOPRE_MPR, 12, 2)
      End If
      ...
      If g_rst_Princi!SOLMAE_TASESP = 0 Or g_rst_Princi!SOLMAE_TASESP = 1 Then
         p_Grid.Col = 1:                       p_Grid.Text = moddat_gf_Consulta_TipSeg(g_rst_Princi!SOLMAE_ESGDES, g_rst_Princi!SOLMAE_TIPSEG)
      Else
         p_Grid.Col = 1:                       p_Grid.Text = moddat_gf_Consulta_TipSeg(g_rst_Princi!SOLMAE_ESGDES, g_rst_Princi!SOLMAE_TIPSEG) & " - " & Trim(Replace(moddat_gf_Consulta_ParDes("522", CStr(g_rst_Princi!SOLMAE_TASESP)), "ADIC", "")) & " ADICIONAL"
      End If
   ...
   Else
      ...
      p_Grid.Col = 0:                     p_Grid.Text = "                Aporte Propio"
      p_Grid.Col = 1:                     p_Grid.CellFontName = "Lucida Console"
      p_Grid.CellFontSize = 8:            p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(CDbl(IIf(moddat_g_int_TipMon = 1, g_rst_Princi!HIPMAE_APOSOL, g_rst_Princi!HIPMAE_APODOL)) - (CDbl(g_rst_Princi!SOLMAE_FMVBBP) + CDbl(g_rst_Princi!SOLMAE_PBPMTO)) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_BMSMTO), 0, g_rst_Princi!SOLMAE_BMSMTO)) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_AFPMTO), 0, g_rst_Princi!SOLMAE_AFPMTO)), 12, 2) 'g_rst_Princi!HIPMAE_APOSOL

      'ADICION NUEVA PBP
      If Not IsNull(g_rst_Princi!SOLMAE_PBPMTO) And g_rst_Princi!SOLMAE_PBPMTO <> 0 Then
         p_Grid.Rows = p_Grid.Rows + 1: p_Grid.Row = p_Grid.Rows - 1
         'p_Grid.Col = 0:                     p_Grid.Text = "                Importe PBP"
         p_Grid.Col = 0:                      p_Grid.Text = "                " & IIf(r_str_CadBon = "", "Importe PBP", r_str_CadBon)
         p_Grid.Col = 1:                     p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:            p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(IIf(IsNull(g_rst_Princi!SOLMAE_PBPMTO), 0, g_rst_Princi!SOLMAE_PBPMTO), 12, 2)
      End If
               
      If Not IsNull(g_rst_Princi!SOLMAE_FMVBBP) And g_rst_Princi!SOLMAE_FMVBBP <> 0 Then
         p_Grid.Rows = p_Grid.Rows + 1: p_Grid.Row = p_Grid.Rows - 1
         'p_Grid.Col = 0:                     p_Grid.Text = "                Importe BBP"
         p_Grid.Col = 0:                      p_Grid.Text = "                " & IIf(r_str_CadBon = "", "Importe BBP", r_str_CadBon)
         p_Grid.Col = 1:                     p_Grid.CellFontName = "Lucida Console"
   ...
   modmip_g_int_PaiRes = g_rst_Princi!DATGEN_PAIRES
   ...
   r_arr_Mtz(0).DatCom_MtoInm_Sol = g_rst_Princi!SOLMAE_MTOINM
   r_arr_Mtz(0).DatCom_MtoEst_Sol = g_rst_Princi!SOLMAE_MTOEST
   r_arr_Mtz(0).DatCom_ApoPro_Sol = g_rst_Princi!SOLMAE_APOPRO_SOL
   r_arr_Mtz(0).DatCom_FmvBbp_Sol = g_rst_Princi!SOLMAE_FMVBBP
   r_arr_Mtz(0).DatCom_MefPbp_Sol = g_rst_Princi!SOLMAE_PBPMTO
   r_arr_Mtz(0).DatCom_MtoAFP_Sol = g_rst_Princi!SOLMAE_AFPMTO
   r_arr_Mtz(0).DatCom_MtoBMS_Sol = g_rst_Princi!SOLMAE_BMSMTO
   r_arr_Mtz(0).DatCom_MtoGCi_Sol = g_rst_Princi!SOLMAE_MTOGCI
   r_arr_Mtz(0).DatCom_PreMto_Sol = g_rst_Princi!SOLMAE_PREMTO
   ...
   r_arr_Mtz(0).DatCom_TasEsp = IIf(IsNull(g_rst_Princi!SOLMAE_TASESP) = True, 0, g_rst_Princi!SOLMAE_TASESP)
   r_arr_Mtz(0).DatCom_BmsTas = g_rst_Princi!SOLMAE_BMSTAS

   If modmip_g_int_Filtro_Sit > 0 Then
     'Almacenando en Variables Globales
      ...
      modmip_g_int_DiaMor = g_rst_Princi!HIPMAE_DIAMOR
...
Private Sub modmip_gs_ActEco_Dep(p_Grid As MSFlexGrid)
  ...
  If Trim(g_rst_Princi!ACTECO_DEP_TIPIDE & "") <> "" Then
      ...
      p_Grid.Col = 1
      p_Grid.Text = moddat_gf_Consulta_ParDes("380", g_rst_Princi!ACTECO_DEP_TIPIDE)
   End If
...
Private Sub modmip_gs_ActEco_Ind(p_Grid As MSFlexGrid)
  ...
  If Trim(g_rst_Princi!ACTECO_IND_TIPIDE & "") <> "" Then
      ...
      p_Grid.Col = 1
      p_Grid.Text = moddat_gf_Consulta_ParDes("381", g_rst_Princi!ACTECO_IND_TIPIDE)
   End If
...
Public Sub modmip_gs_EvaSeg(p_Grid As MSFlexGrid, Optional p_TxtObs As TextBox)
   
   If Not p_TxtObs Is Nothing Then
      p_TxtObs.Text = ""
   End If
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      If Not (g_rst_Genera.BOF And g_rst_Genera.EOF) Then g_rst_Genera.MoveFirst
      ...
      If Not (g_rst_Genera.BOF And g_rst_Genera.EOF) Then
         p_Grid.Rows = p_Grid.Rows + 1:   p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                  p_Grid.Text = "Fecha Emisión Póliza"
         p_Grid.Col = 1:                  p_Grid.Text = gf_FormatoFecha(CStr(g_rst_Genera!POLIZA_FEMDES))
   
         p_Grid.Rows = p_Grid.Rows + 1:   p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                  p_Grid.Text = "Número de Póliza"
         p_Grid.Col = 1:                  p_Grid.Text = Trim(g_rst_Genera!POLIZA_NUMDES & "") & IIf(Len(Trim(g_rst_Genera!POLIZA_NUMCYG & "")) > 0, " / " & Trim(g_rst_Genera!POLIZA_NUMCYG & ""), "")
      End If
      ...
      If Not (g_rst_Genera.BOF And g_rst_Genera.EOF) Then
         p_Grid.Rows = p_Grid.Rows + 1:   p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                  p_Grid.Text = "Fecha Emisión Póliza"
         p_Grid.Col = 1:                  p_Grid.Text = gf_FormatoFecha(CStr(g_rst_Genera!POLIZA_FEMVIV))
         
         p_Grid.Rows = p_Grid.Rows + 1:   p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                  p_Grid.Text = "Número de Póliza"
         p_Grid.Col = 1:                  p_Grid.Text = Trim(g_rst_Genera!POLIZA_NUMVIV & "")
      End If
...
Public Sub modmip_gs_Buscar_EvaLeg(p_Grid1 As MSFlexGrid, p_Grid2 As MSFlexGrid, p_TxtObs As TextBox, Optional p_TxtCom As TextBox)
   If Not p_TxtCom Is Nothing Then
      p_TxtCom.Text = ""
   End If
   ...
   If Not (g_rst_Princi.BOF And g_rst_Princi.EOF) Then
      ...
      If g_rst_Princi!EVALEG_FECCOM > 0 Then
       ...
       Else
         ...
         If Not (g_rst_Genera.BOF And g_rst_Genera.EOF) Then
            If g_rst_Genera!EVACRE_FECCOM > 0 And Not p_TxtCom Is Nothing Then
               p_TxtCom.Text = "Fecha del Comité de Créditos: " & gf_FormatoFecha(CStr(g_rst_Genera!EVACRE_FECCOM)) & Chr(13) & Chr(10) & Chr(13) & Chr(10) & "Numero de Acta del Comité de Créditos: " & Trim(g_rst_Genera!EVACRE_NROACT & "")
            End If
         End If
...
'------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   With r_obj_Excel.ActiveSheet
      ...
      .Cells(1, 7) = "F. SOLICITUD":                  .Columns("G").ColumnWidth = 15:        .Columns("G").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 8) = "F. INGRESO INSTANCIA":          .Columns("H").ColumnWidth = 22:        .Columns("H").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 9) = "TIPO EVALUACION":               .Columns("I").ColumnWidth = 40:        .Columns("I").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 10) = "CONSEJERO HIPOTECARIO":        .Columns("J").ColumnWidth = 25:        .Columns("J").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 11) = "ANALISTA CREDITOS":            .Columns("K").ColumnWidth = 22:        .Columns("K").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 12) = "INSTANCIA":                    .Columns("L").ColumnWidth = 30:        .Columns("L").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 13) = "TIEMPO INSTANCIA":             .Columns("M").ColumnWidth = 20:        .Columns("M").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 14) = "TIEMPO OBSERVADO":             .Columns("N").ColumnWidth = 20:        .Columns("N").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 15) = "TIEMPO EVALUACION":            .Columns("O").ColumnWidth = 20:        .Columns("O").HorizontalAlignment = xlHAlignCenter
      ...
      .Cells(1, 22) = "SITUACION INSTANCIA":          .Columns("V").ColumnWidth = 22:        .Columns("V").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 23) = "OBSERVACION":                  .Columns("W").ColumnWidth = 200
   ...
   Do While Not r_rst_SolMae.EOF
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 1) = r_int_ConVer - 1
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 2) = moddat_gf_Consulta_Produc(r_rst_SolMae!SOLMAE_CODPRD)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 3) = moddat_gf_Consulta_SubPrd(r_rst_SolMae!SOLMAE_CODPRD, r_rst_SolMae!SOLMAE_CODSUB)
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 8) = CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECINI)))
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 11) = Trim(r_rst_SolMae!SEGUSUACT)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 12) = moddat_gf_Consulta_ParDes("002", CStr(p_CodIns))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 13) = r_int_TpoIns
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 14) = r_int_TpoObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 15) = r_int_TpoIns - r_int_TpoObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 16) = moddat_gf_Consulta_ParDes("229", CStr(r_rst_SolMae!SOLMAE_TIPMON))
   
      If r_rst_SolMae!SOLMAE_TIPMON = 1 Then
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 17) = Format(r_rst_SolMae!SOLMAE_COMVTA_SOL, "###,###0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 18) = Format(r_rst_SolMae!SOLMAE_APOPRO_SOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 19) = Format(r_rst_SolMae!SOLMAE_APOPRO_SOL / r_rst_SolMae!SOLMAE_COMVTA_SOL * 100, "##0.00") & "%"
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 20) = Format(r_rst_SolMae!SOLMAE_MTOPRE_MPR, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 21) = 0
      Else
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 17) = Format(r_rst_SolMae!SOLMAE_COMVTA_DOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 18) = Format(r_rst_SolMae!SOLMAE_APOPRO_DOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 19) = Format(r_rst_SolMae!SOLMAE_APOPRO_DOL / r_rst_SolMae!SOLMAE_COMVTA_DOL * 100, "##0.00") & "%"
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 20) = 0
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 21) = Format(r_rst_SolMae!SOLMAE_MTOPRE_MPR, "###,##0.00")
      End If
      
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 22) = moddat_gf_Consulta_ParDes("023", CStr(r_rst_SolMae!SEGUIM_SITUAC))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 23) = r_str_DetObs
...
Dim r_str_FecEnv     As String
   ...
   g_str_Parame = g_str_Parame & "       TRIM(P.PARDES_DESCRI) AS SITUACION_ACTUAL, SOLMAE_SITUAC, TRIM(Q.PARDES_DESCRI) AS INSTANCIA_ACTUAL, TRIM(R.PARDES_DESCRI) AS MOT_RECHAZO, B.SEGUSUACT ANALISTA,"
   g_str_Parame = g_str_Parame & "    (SELECT TRIM(X2.PARDES_DESCRI) FROM CLI_ACTECO X1 "
   g_str_Parame = g_str_Parame & "       LEFT JOIN MNT_PARDES X2 ON X2.PARDES_CODGRP = '008' AND X2.PARDES_CODITE = X1.ACTECO_CODACT "
   g_str_Parame = g_str_Parame & "      Where X1.ACTECO_CLITDO = D.DATGEN_TIPDOC "
   g_str_Parame = g_str_Parame & "        AND X1.ACTECO_CLINDO = D.DATGEN_NUMDOC "
   g_str_Parame = g_str_Parame & "        AND X1.ACTECO_ORDACT = 1) AS ACTIVIDAD_ECONOMICA, "
   g_str_Parame = g_str_Parame & "    (SELECT CASE WHEN S.ACTECO_CODACT = 11 THEN (SELECT TRIM(X1.PARDES_DESCRI) FROM MNT_PARDES X1 WHERE X1.PARDES_CODGRP = 380 AND X1.PARDES_CODITE = S.ACTECO_DEP_TIPIDE) "
   g_str_Parame = g_str_Parame & "                 WHEN S.ACTECO_CODACT = 21 THEN (SELECT TRIM(X2.PARDES_DESCRI) FROM MNT_PARDES X2 WHERE X2.PARDES_CODGRP = 381 AND X2.PARDES_CODITE = S.ACTECO_IND_TIPIDE) "
   g_str_Parame = g_str_Parame & "                 Else '' "
   g_str_Parame = g_str_Parame & "            End "
   g_str_Parame = g_str_Parame & "       FROM CLI_ACTECO S "
   g_str_Parame = g_str_Parame & "       LEFT JOIN MNT_PARDES T ON T.PARDES_CODGRP = '008' AND T.PARDES_CODITE = S.ACTECO_CODACT "
   g_str_Parame = g_str_Parame & "      Where s.ACTECO_CLITDO = D.DATGEN_TIPDOC "
   g_str_Parame = g_str_Parame & "        AND S.ACTECO_CLINDO = D.DATGEN_NUMDOC "
   g_str_Parame = g_str_Parame & "        AND S.ACTECO_ORDACT = 1) AS TIPO_INGRESO "
   g_str_Parame = g_str_Parame & "  FROM CRE_SOLMAE A "
   ...
   Select Case p_TipFil
      ...
      Case 5: If Len(Trim(p_CodFil)) > 0 Then g_str_Parame = g_str_Parame & " WHERE  B.SEGUSUACT = '" & p_CodFil & "' "
   End Select
   If (Len(Trim(p_CodIte)) > 0) Then
   ...
   With r_obj_Excel.ActiveSheet
      .Cells(1, 1) = "ITEM":                          .Columns("A").ColumnWidth = 6:         .Columns("A").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 2) = "PRODUCTO":                      .Columns("B").ColumnWidth = 52:        .Columns("B").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 3) = "SUB-PRODUCTO":                  .Columns("C").ColumnWidth = 74:        .Columns("C").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 4) = "SOLICITUD":                     .Columns("D").ColumnWidth = 16:        .Columns("D").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 5) = "DOC. IDENTIDAD":                .Columns("E").ColumnWidth = 16:        .Columns("E").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 6) = "NOMBRE CLIENTE":                .Columns("F").ColumnWidth = 45
      .Cells(1, 7) = "F. SOLICITUD":                  .Columns("G").ColumnWidth = 12:        .Columns("G").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 8) = "F. ENVIO CRED.":                .Columns("H").ColumnWidth = 14:        .Columns("H").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 9) = "TASA":                          .Columns("I").ColumnWidth = 8:
      .Cells(1, 10) = "PLAZO":                        .Columns("J").ColumnWidth = 8:        .Columns("J").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 11) = "NRO. DE ACTA":                 .Columns("K").ColumnWidth = 14:        .Columns("K").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 12) = "TIPO EVALUACION":              .Columns("L").ColumnWidth = 25:        .Columns("L").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 13) = "CONSEJERO HIPOTECARIO":        .Columns("M").ColumnWidth = 25:        .Columns("M").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 14) = "ANALISTA CREDITOS":            .Columns("N").ColumnWidth = 23:        .Columns("N").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 15) = "ACTIVIDAD ECONOMICA":          .Columns("O").ColumnWidth = 45:        .Columns("O").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 16) = "TIPO INGRESO":                 .Columns("P").ColumnWidth = 31:        .Columns("P").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 17) = "INSTANCIA":                    .Columns("Q").ColumnWidth = 25:        .Columns("Q").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 18) = "RESULTADO EVALUACION":         .Columns("R").ColumnWidth = 25:        .Columns("R").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 19) = "INGRESO INSTANCIA":            .Columns("S").ColumnWidth = 9:        .Columns("S").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 20) = "SALIDA INSTANCIA":             .Columns("T").ColumnWidth = 17:        .Columns("T").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 21) = "TIEMPO INSTANCIA":             .Columns("U").ColumnWidth = 18:        .Columns("U").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 22) = "TIEMPO OBSERVADO":             .Columns("V").ColumnWidth = 19:        .Columns("V").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 23) = "TIEMPO EVALUACION":            .Columns("W").ColumnWidth = 20:        .Columns("W").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 24) = "MONEDA":                       .Columns("X").ColumnWidth = 10:        .Columns("X").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 25) = "V. INMUEBLE":                  .Columns("Y").ColumnWidth = 13
      .Cells(1, 26) = "CUOTA INICIAL":                .Columns("Z").ColumnWidth = 14
      .Cells(1, 27) = "PORC. INICIAL":                .Columns("AA").ColumnWidth = 13
      .Cells(1, 28) = "MTO. CREDITO S/.":             .Columns("AB").ColumnWidth = 18
      .Cells(1, 29) = "MTO. CREDITO US$":             .Columns("AC").ColumnWidth = 19
      .Cells(1, 30) = "MODALIDAD":                    .Columns("AD").ColumnWidth = 53
      .Cells(1, 31) = "PROYECTO INMOBILIARIO":        .Columns("AE").ColumnWidth = 55
      .Cells(1, 32) = "MOTIVO RECHAZO":               .Columns("AF").ColumnWidth = 96
      .Cells(1, 33) = "COD. EXCEP.":                  .Columns("AG").ColumnWidth = 15:       .Columns("AG").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 34) = "EXCEPCION":                    .Columns("AH").ColumnWidth = 80
      .Cells(1, 35) = "OBSERVACION EXCEPCION":        .Columns("AI").ColumnWidth = 112
      .Cells(1, 36) = "CONDICIONES":                  .Columns("AJ").ColumnWidth = 100
      .Cells(1, 37) = "SITUACION ACTUAL":             .Columns("AK").ColumnWidth = 47:       .Columns("AK").HorizontalAlignment = xlHAlignCenter
      
      .Range(.Cells(1, 1), .Cells(1, 37)).Font.Bold = True
      .Range(.Cells(1, 1), .Cells(1, 37)).HorizontalAlignment = xlHAlignCenter
   End With
   ...
   Do While Not r_rst_SolMae.EOF
      ...
      '***Abriendo Cursor para obtener Fecha de Envío a Recepción a Crédito
      r_str_FecEnv = ""
      r_str_Cadena = ""
      r_str_Cadena = r_str_Cadena & "SELECT SEGDET_CODOCU, SEGDET_FECOCU FROM TRA_SEGDET WHERE SEGDET_NUMSOL = '" & r_rst_SolMae!SOLMAE_NUMERO & "' "
      r_str_Cadena = r_str_Cadena & "   AND SEGDET_CODINS = 11 "
      r_str_Cadena = r_str_Cadena & "   AND SEGDET_CODOCU = 92 "
      ...
      If Not (r_rst_SegDet.BOF And r_rst_SegDet.EOF) Then
         r_rst_SegDet.MoveFirst
         r_str_FecEnv = CStr(r_rst_SegDet!SEGDET_FECOCU)
      End If
      
      r_rst_SegDet.Close
      Set r_rst_SegDet = Nothing
      
      If r_str_FecEnv = "" Then
         r_str_Cadena = ""
         r_str_Cadena = r_str_Cadena & "SELECT SEGDET_CODOCU, MIN(SEGDET_FECOCU) AS FECOCU FROM TRA_SEGDET WHERE SEGDET_NUMSOL = '" & r_rst_SolMae!SOLMAE_NUMERO & "' "
         r_str_Cadena = r_str_Cadena & "   AND SEGDET_CODINS = 11 "
         r_str_Cadena = r_str_Cadena & "   AND SEGDET_CODOCU = 90 "
         r_str_Cadena = r_str_Cadena & " GROUP BY SEGDET_CODOCU "
         ...
         If Not (r_rst_SegDet.BOF And r_rst_SegDet.EOF) Then
            r_rst_SegDet.MoveFirst
            r_str_FecEnv = CStr(r_rst_SegDet!FECOCU)
         End If
      ...
      If r_str_FecEnv <> "" Then
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 8) = "'" & CDate(gf_FormatoFecha(CStr(r_str_FecEnv)))
      End If
      
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 9) = r_rst_SolMae!SOLMAE_TASINT
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 10) = r_rst_SolMae!SOLMAE_PLAANO
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 11) = Trim(r_rst_SolMae!NRO_ACTA)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 12) = Trim(r_rst_SolMae!TIPO_EVALUAC)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 13) = Trim(r_rst_SolMae!SOLMAE_CONHIP)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 14) = Trim(r_rst_SolMae!ANALISTA)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 15) = Trim(r_rst_SolMae!ACTIVIDAD_ECONOMICA)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 16) = Trim(r_rst_SolMae!TIPO_INGRESO)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 17) = Trim(r_rst_SolMae!INSTANCIA)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 18) = Trim(r_rst_SolMae!SITUACION)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 19) = "'" & CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECINI)))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 20) = "'" & CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECFIN)))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 21) = CInt(CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECFIN))) - CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECINI))))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 22) = r_int_TpoObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 23) = CInt(CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECFIN))) - CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECINI)))) - r_int_TpoObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 24) = Trim(r_rst_SolMae!TIPO_MONEDA)
      
      If r_rst_SolMae!SOLMAE_TIPMON = 1 Then
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 25) = Format(r_rst_SolMae!SOLMAE_COMVTA_SOL, "###,###0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 26) = Format(r_rst_SolMae!SOLMAE_APOPRO_SOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 27) = Format(r_rst_SolMae!SOLMAE_APOPRO_SOL / r_rst_SolMae!SOLMAE_COMVTA_SOL * 100, "##0.00") & "%"
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 28) = Format(r_rst_SolMae!SOLMAE_MTOPRE_MPR, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 29) = 0
      Else
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 25) = Format(r_rst_SolMae!SOLMAE_COMVTA_DOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 26) = Format(r_rst_SolMae!SOLMAE_APOPRO_DOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 27) = Format(r_rst_SolMae!SOLMAE_APOPRO_DOL / r_rst_SolMae!SOLMAE_COMVTA_DOL * 100, "##0.00") & "%"
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 28) = 0
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 29) = Format(r_rst_SolMae!SOLMAE_MTOPRE_MPR, "###,##0.00")
      End If
      
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 30) = Trim(r_rst_SolMae!MODALIDAD)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 31) = Trim(r_rst_SolMae!DATGEN_TITULO)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 32) = r_str_DetObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 33) = Trim(r_rst_SolMae!SEGEXC_MOTEXC)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 34) = Trim(r_rst_SolMae!EXCEPCION)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 35) = Trim(r_rst_SolMae!DESCRI_EXCEP)
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 36) = Trim(r_str_DetObs)
      
      If r_rst_SolMae!SOLMAE_SITUAC = 1 Then
         'En Tramite
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 37) = Trim(r_rst_SolMae!SITUACION_ACTUAL) & " - " & Trim(r_rst_SolMae!INSTANCIA_ACTUAL)
      ElseIf r_rst_SolMae!SOLMAE_SITUAC = 2 Then
         'Desembolsada
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 37) = Trim(r_rst_SolMae!SITUACION_ACTUAL) & " - " & IIf(r_rst_SolMae!HIPMAE_FECDES = 0, "", gf_FormatoFecha(CStr(r_rst_SolMae!HIPMAE_FECDES)))
         
      ElseIf r_rst_SolMae!SOLMAE_SITUAC = 3 Then
         'Rechazada
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 37) = Trim(r_rst_SolMae!SITUACION_ACTUAL) & " - " & Trim(r_rst_SolMae!MOT_RECHAZO)
      Else
         'Otro
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 37) = "NO SE PUDO DETERMINAR SITUACION"
      End If
   ...
   Select Case p_TipFil
      Case 1   'Producto
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 36)).Sort r_obj_Excel.Range("B1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
      Case 2   'Consejero Hipotecario
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 36)).Sort r_obj_Excel.Range("I1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
      Case 3   'Modalidad - Proyecto
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 36)).Sort r_obj_Excel.Range("X1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
      Case 4   'Tipo de Evaluación
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 36)).Sort r_obj_Excel.Range("H1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
   End Select
...
Public Sub modmip_gs_Exc_EvaSol_OLD(ByVal p_CodIns As Integer, ByVal p_TipFil As Integer, ByVal p_CodFil As String, ByVal p_Situac As Integer, ByVal p_FecIni As String, ByVal p_FecFin As String, ByVal p_CodIte As String)
'------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
'Parámetros    :
'                 p_CodIns    -  Código de Instancia
'                 p_TipFil    -  Tipo de Filtro
...
Dim r_str_FecEnv     As String
   ...
   With r_obj_Excel.ActiveSheet
      ...
      .Cells(1, 8) = "F. ENVIO CRED.":                .Columns("H").ColumnWidth = 13.5:        .Columns("H").HorizontalAlignment = xlHAlignCenter
      
      .Cells(1, 9) = "TASA":                          .Columns("I").ColumnWidth = 10:
      .Cells(1, 10) = "PLAZO":                        .Columns("J").ColumnWidth = 10:        .Columns("J").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 11) = "NRO. DE ACTA":                 .Columns("K").ColumnWidth = 13:        .Columns("K").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 12) = "TIPO EVALUACION":              .Columns("L").ColumnWidth = 22:        .Columns("L").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 13) = "CONSEJERO HIPOTECARIO":        .Columns("M").ColumnWidth = 24:        .Columns("M").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 14) = "ANALISTA CREDITOS":            .Columns("N").ColumnWidth = 24:        .Columns("N").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 15) = "INSTANCIA":                    .Columns("O").ColumnWidth = 24:        .Columns("O").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 16) = "RESULTADO EVALUACION":         .Columns("P").ColumnWidth = 24:        .Columns("P").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 17) = "INGRESO INSTANCIA":            .Columns("Q").ColumnWidth = 18:        .Columns("Q").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 18) = "SALIDA INSTANCIA":             .Columns("R").ColumnWidth = 18:        .Columns("R").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 19) = "TIEMPO INSTANCIA":             .Columns("S").ColumnWidth = 18:        .Columns("S").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 20) = "TIEMPO OBSERVADO":             .Columns("T").ColumnWidth = 18:        .Columns("T").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 21) = "TIEMPO EVALUACION":            .Columns("U").ColumnWidth = 20:        .Columns("U").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 22) = "MONEDA":                       .Columns("V").ColumnWidth = 10:        .Columns("V").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 23) = "V. INMUEBLE":                  .Columns("W").ColumnWidth = 12
      .Cells(1, 24) = "CUOTA INICIAL":                .Columns("X").ColumnWidth = 14
      .Cells(1, 25) = "PORC. INICIAL":                .Columns("Y").ColumnWidth = 13
      .Cells(1, 26) = "MTO. CREDITO S/.":             .Columns("Z").ColumnWidth = 18
      .Cells(1, 27) = "MTO. CREDITO US$":             .Columns("AA").ColumnWidth = 18
      .Cells(1, 28) = "MODALIDAD":                    .Columns("AB").ColumnWidth = 50
      .Cells(1, 29) = "PROYECTO INMOBILIARIO":        .Columns("AC").ColumnWidth = 50
      .Cells(1, 30) = "MOTIVO RECHAZO":               .Columns("AD").ColumnWidth = 140
      .Cells(1, 31) = "COD. EXCEP.":                  .Columns("AE").ColumnWidth = 15:       .Columns("AE").HorizontalAlignment = xlHAlignCenter
      .Cells(1, 32) = "EXCEPCION":                    .Columns("AF").ColumnWidth = 80
      .Cells(1, 33) = "OBSERVACION EXCEPCION":        .Columns("AGF").ColumnWidth = 100
      .Cells(1, 34) = "CONDICIONES":                  .Columns("AH").ColumnWidth = 100
      .Cells(1, 35) = "SITUACION ACTUAL":             .Columns("AI").ColumnWidth = 50:       .Columns("AI").HorizontalAlignment = xlHAlignCenter
      
      .Range(.Cells(1, 1), .Cells(1, 35)).Font.Bold = True
      .Range(.Cells(1, 1), .Cells(1, 35)).HorizontalAlignment = xlHAlignCenter
   End With
   ...
   Do While Not r_rst_SolMae.EOF
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 13) = Trim(r_rst_SolMae!SOLMAE_CONHIP)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 14) = Trim(r_rst_SolMae!ANALISTA)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 15) = Trim(r_rst_SolMae!INSTANCIA)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 16) = Trim(r_rst_SolMae!SITUACION)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 17) = "'" & CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECINI)))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 18) = "'" & CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECFIN)))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 19) = CInt(CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECFIN))) - CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECINI))))
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 20) = r_int_TpoObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 21) = CInt(CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECFIN))) - CDate(gf_FormatoFecha(CStr(r_rst_SolMae!SEGUIM_FECINI)))) - r_int_TpoObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 22) = Trim(r_rst_SolMae!TIPO_MONEDA)
      
      If r_rst_SolMae!SOLMAE_TIPMON = 1 Then
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 23) = Format(r_rst_SolMae!SOLMAE_COMVTA_SOL, "###,###0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 24) = Format(r_rst_SolMae!SOLMAE_APOPRO_SOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 25) = Format(r_rst_SolMae!SOLMAE_APOPRO_SOL / r_rst_SolMae!SOLMAE_COMVTA_SOL * 100, "##0.00") & "%"
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 26) = Format(r_rst_SolMae!SOLMAE_MTOPRE_MPR, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 27) = 0
      Else
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 23) = Format(r_rst_SolMae!SOLMAE_COMVTA_DOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 24) = Format(r_rst_SolMae!SOLMAE_APOPRO_DOL, "###,##0.00")
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 25) = Format(r_rst_SolMae!SOLMAE_APOPRO_DOL / r_rst_SolMae!SOLMAE_COMVTA_DOL * 100, "##0.00") & "%"
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 26) = 0
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 27) = Format(r_rst_SolMae!SOLMAE_MTOPRE_MPR, "###,##0.00")
      End If
      
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 28) = Trim(r_rst_SolMae!MODALIDAD)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 29) = Trim(r_rst_SolMae!DATGEN_TITULO)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 30) = r_str_DetObs
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 31) = Trim(r_rst_SolMae!SEGEXC_MOTEXC)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 32) = Trim(r_rst_SolMae!EXCEPCION)
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 33) = Trim(r_rst_SolMae!DESCRI_EXCEP)
      ...
      r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 34) = Trim(r_str_DetObs)
      
      If r_rst_SolMae!SOLMAE_SITUAC = 1 Then
         'En Tramite
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 35) = Trim(r_rst_SolMae!SITUACION_ACTUAL) & " - " & Trim(r_rst_SolMae!INSTANCIA_ACTUAL)
      ElseIf r_rst_SolMae!SOLMAE_SITUAC = 2 Then
         'Desembolsada
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 35) = Trim(r_rst_SolMae!SITUACION_ACTUAL) & " - " & IIf(r_rst_SolMae!HIPMAE_FECDES = 0, "", gf_FormatoFecha(CStr(r_rst_SolMae!HIPMAE_FECDES)))
         
      ElseIf r_rst_SolMae!SOLMAE_SITUAC = 3 Then
         'Rechazada
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 35) = Trim(r_rst_SolMae!SITUACION_ACTUAL) & " - " & Trim(r_rst_SolMae!MOT_RECHAZO)
      Else
         'Otro
         r_obj_Excel.ActiveSheet.Cells(r_int_ConVer, 35) = "NO SE PUDO DETERMINAR SITUACION"
      End If
   ...
   Select Case p_TipFil
      Case 1   'Producto
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 34)).Sort r_obj_Excel.Range("B1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
      Case 2   'Consejero Hipotecario
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 34)).Sort r_obj_Excel.Range("I1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
      Case 3   'Modalidad - Proyecto
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 34)).Sort r_obj_Excel.Range("X1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
      Case 4   'Tipo de Evaluación
         r_obj_Excel.ActiveSheet.Range(r_obj_Excel.ActiveSheet.Cells(1, 2), r_obj_Excel.Cells(r_int_ConVer - 1, 34)).Sort r_obj_Excel.Range("H1"), xlAscending, r_obj_Excel.Range("E1"), , xlAscending, , , xlYes
   End Select
...
Dim r_str_CadBon     As String
   ...
   g_rst_Princi.MoveFirst
   r_str_CadBon = IIf(g_rst_Princi!HIPMAE_CODPRD = "024", "Importe BFH", IIf(g_rst_Princi!HIPMAE_CODPRD = "021" Or g_rst_Princi!HIPMAE_CODPRD = "022", "Importe BBP", ""))
   ...
   'Obteniendo Nombre de Cliente
   moddat_g_str_NomCli = moddat_gf_Buscar_NomCli(moddat_g_int_TipDoc, moddat_g_str_NumDoc, 1)
   ...
   If moddat_g_int_Situac = 6 Then
      ...
      p_Grid.Text = modmip_gs_OpeTransferido(p_NumOpe, moddat_g_str_Situac, g_rst_Princi!HIPMAE_FECCAN)
   Else
   ...
   If g_rst_Princi!SOLMAE_COMVTA_SOL > 0 Then
      ...
      If Not IsNull(g_rst_Princi!SOLMAE_MTOINM) And g_rst_Princi!SOLMAE_MTOINM <> 0 Then
         ...
         p_Grid.Col = 0:                    p_Grid.Text = "                Importe Inmueble"
         p_Grid.Col = 1:                    p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:           p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(IIf(IsNull(g_rst_Princi!SOLMAE_MTOINM), 0, g_rst_Princi!SOLMAE_MTOINM), 12, 2)
      End If
      ...
      If Not IsNull(g_rst_Princi!SOLMAE_MTOEST) And g_rst_Princi!SOLMAE_MTOEST <> 0 Then
         ...
         p_Grid.Col = 0:                    p_Grid.Text = "                Importe Estacionamiento"
         p_Grid.Col = 1:                    p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:           p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(IIf(IsNull(g_rst_Princi!SOLMAE_MTOEST), 0, g_rst_Princi!SOLMAE_MTOEST), 12, 2)
      End If

      p_Grid.Rows = p_Grid.Rows + 1:    p_Grid.Row = p_Grid.Rows - 1
      p_Grid.Col = 0:                       p_Grid.Text = "Cuota Inicial"
      p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
      p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & IIf(moddat_g_int_TipMon = 1, gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_SOL, 12, 2), gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_DOL, 12, 2)) & " (" & Format((IIf(moddat_g_int_TipMon = 1, CDbl(g_rst_Princi!SOLMAE_APOPRO_SOL), CDbl(g_rst_Princi!SOLMAE_APOPRO_DOL)) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_FMVBBP), 0, g_rst_Princi!SOLMAE_FMVBBP)) - CDbl(g_rst_Princi!SOLMAE_PBPMTO) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_BMSMTO), 0, g_rst_Princi!SOLMAE_BMSMTO))) / IIf(moddat_g_int_TipMon = 1, CDbl(g_rst_Princi!SOLMAE_COMVTA_SOL), CDbl(g_rst_Princi!SOLMAE_COMVTA_DOL)) * 100, "##0.00") & "%)"
      
      p_Grid.Rows = p_Grid.Rows + 1: p_Grid.Row = p_Grid.Rows - 1
      p_Grid.Col = 0:                    p_Grid.Text = "                Aporte Propio"
      p_Grid.Col = 1:                    p_Grid.CellFontName = "Lucida Console"
      p_Grid.CellFontSize = 8:           p_Grid.Text = "                " & moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(CDbl(IIf(moddat_g_int_TipMon = 1, g_rst_Princi!SOLMAE_APOPRO_SOL, g_rst_Princi!SOLMAE_APOPRO_DOL)) - (CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_FMVBBP), 0, g_rst_Princi!SOLMAE_FMVBBP)) + CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_PBPMTO), 0, g_rst_Princi!SOLMAE_PBPMTO))) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_BMSMTO), 0, g_rst_Princi!SOLMAE_BMSMTO)) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_AFPMTO), 0, g_rst_Princi!SOLMAE_AFPMTO)), 12, 2)
      ...
      If Not IsNull(g_rst_Princi!SOLMAE_PREMTO) And g_rst_Princi!SOLMAE_PREMTO <> 0 Then
         ...
         p_Grid.Col = 0:                       p_Grid.Text = "Monto Préstamo"
         p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_PREMTO, 12, 2)
      End If
      If Not IsNull(g_rst_Princi!SOLMAE_MTOGCI) And g_rst_Princi!SOLMAE_MTOGCI <> 0 Then
         p_Grid.Rows = p_Grid.Rows + 1:    p_Grid.Row = p_Grid.Rows - 1
         p_Grid.Col = 0:                       p_Grid.Text = "Gasto Cierre"
         p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
         p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(g_rst_Princi!SOLMAE_MTOGCI, 12, 2)
      End If
   End If
   
   p_Grid.Rows = p_Grid.Rows + 1:    p_Grid.Row = p_Grid.Rows - 1
   p_Grid.Col = 0:                       p_Grid.Text = "Monto Total"
   p_Grid.Col = 1:                       p_Grid.CellFontName = "Lucida Console"
   p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & gf_FormatoNumero(g_rst_Princi!HIPMAE_MTOPRE, 12, 2)
   ...
   If InStr(moddat_g_str_Agr1MIC, moddat_g_str_CodPrd) = 0 Then ' moddat_g_str_CodPrd <> "002" And moddat_g_str_CodPrd <> "011" Then
      ...
      p_Grid.Rows = p_Grid.Rows + 1:       p_Grid.Row = p_Grid.Rows - 1
      p_Grid.Col = 0:                          p_Grid.Text = "Monto Préstamo (TNC)"
      p_Grid.Col = 1:                          p_Grid.CellFontName = "Lucida Console"
      ...
      p_Grid.Rows = p_Grid.Rows + 1:       p_Grid.Row = p_Grid.Rows - 1
      p_Grid.Col = 0:                          p_Grid.Text = "Monto Préstamo (TC)"
      p_Grid.Col = 1:                          p_Grid.CellFontName = "Lucida Console"
...
Public Function modmip_gs_OpeTransferido(ByVal p_NumOpe As String, ByVal p_Situac As String, ByVal p_Fecha As String) As String
Dim r_str_Parame  As String
Dim r_rst_Princi  As ADODB.Recordset

   modmip_gs_OpeTransferido = p_Situac & "  |  FECHA : " & gf_FormatoFecha(CStr(p_Fecha))

   r_str_Parame = ""
   r_str_Parame = r_str_Parame & "SELECT TRIM(PARDES_DESCRI) AS ENTIDAD"
   r_str_Parame = r_str_Parame & "  FROM CRE_SALMIG "
   r_str_Parame = r_str_Parame & " INNER JOIN MNT_PARDES ON PARDES_CODGRP = 122 AND TO_NUMBER(PARDES_CODITE) = TO_NUMBER(SALMIG_CODBAN) "
   r_str_Parame = r_str_Parame & " WHERE SALMIG_NUMOPE = '" & p_NumOpe & "' "
   ...
   r_rst_Princi.MoveFirst
   modmip_gs_OpeTransferido = p_Situac & "  |  FECHA : " & gf_FormatoFecha(CStr(p_Fecha)) & "  |  " & r_rst_Princi!ENTIDAD
...
Dim r_str_CodBco     As String
   ...
   If g_rst_Princi!SOLMAE_CYGTDO > 0 Then
      ...
      moddat_g_str_CygNom = moddat_gf_Buscar_NomCli(moddat_g_int_CygTDo, moddat_g_str_CygNDo, 1)
   End If
   ...
   moddat_g_int_FlgCre = g_rst_Princi!SOLMAE_FLGAFP
   ...
   moddat_g_int_MtoAfp = g_rst_Princi!SOLMAE_AFPMTO
   ...
   If g_rst_Princi!SOLMAE_COMVTA_SOL > 0 Then
      ...
      If moddat_g_str_CodPrd = "023" Then
         p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & IIf(moddat_g_int_TipMon = 1, gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_SOL, 12, 2), gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_DOL, 12, 2)) & " (" & Format((IIf(moddat_g_int_TipMon = 1, CDbl(g_rst_Princi!SOLMAE_APOPRO_SOL), CDbl(g_rst_Princi!SOLMAE_APOPRO_DOL))) / IIf(moddat_g_int_TipMon = 1, CDbl(g_rst_Princi!SOLMAE_COMVTA_SOL), CDbl(g_rst_Princi!SOLMAE_COMVTA_DOL)) * 100, "##0.00") & "%)"
      Else
         p_Grid.CellFontSize = 8:              p_Grid.Text = moddat_gf_Consulta_ParDes("229", CStr(moddat_g_int_TipMon)) & " " & IIf(moddat_g_int_TipMon = 1, gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_SOL, 12, 2), gf_FormatoNumero(g_rst_Princi!SOLMAE_APOPRO_DOL, 12, 2)) & " (" & Format((IIf(moddat_g_int_TipMon = 1, CDbl(g_rst_Princi!SOLMAE_APOPRO_SOL), CDbl(g_rst_Princi!SOLMAE_APOPRO_DOL)) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_FMVBBP), 0, g_rst_Princi!SOLMAE_FMVBBP)) - CDbl(g_rst_Princi!SOLMAE_PBPMTO) - CDbl(IIf(IsNull(g_rst_Princi!SOLMAE_BMSMTO), 0, g_rst_Princi!SOLMAE_BMSMTO))) / IIf(moddat_g_int_TipMon = 1, CDbl(g_rst_Princi!SOLMAE_COMVTA_SOL), CDbl(g_rst_Princi!SOLMAE_COMVTA_DOL)) * 100, "##0.00") & "%)"
      End If
